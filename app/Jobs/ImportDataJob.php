...
class ImportDataJob implements ShouldQueue
{
    ...
    protected $forceFullReindex = true; // Set to true to clear and re-index everything
    ...
    protected function processLocations($client)
    {
        ...
        // Preload all location names (parents + standalone) keyed by LocationId
        $parentLocations = DB::table('Location')->pluck('Name', 'LocationId')->all();
        ...
        while (true) {
            ...
            foreach ($locations as $location) {
                $documents[] = [
                	...
                	'tourismScore' => (int) ($location->TourismScore ?? 0),
