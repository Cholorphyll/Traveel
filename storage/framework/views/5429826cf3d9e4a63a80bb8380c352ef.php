   <div class="tr-mobile-nav-section">
      <div class="tr-mobile-nav-content">
        ...
        <div class="tr-nav-header">
          <div class="tr-logo">
            <img src="<?php echo e(asset('frontend/hotel-detail/images/where2.png')); ?>" alt="where2 small logo" style="width: 150px !important; height: auto !important;">
          </div>
          <div class="tr-location">London</div>
        </div>
        <div class="tr-mobile-nav-lists">
          <ul>
            <li><a href="https://www.travell.co.in"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 7.49984L10 1.6665L17.5 7.49984V16.6665C17.5 17.1085 17.3244 17.5325 17.0118 17.845C16.6993 18.1576 16.2754 18.3332 15.8333 18.3332H4.16667C3.72464 18.3332 3.30072 18.1576 2.98816 17.845C2.67559 17.5325 2.5 17.1085 2.5 16.6665V7.49984Z" stroke="#222222" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.5 18.3333V10H12.5V18.3333" stroke="#222222" stroke-linecap="round" stroke-linejoin="round"/></svg>Explore</a></li>
            <li><a href="https://www.travell.co.in/stays"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 7.49984L10 1.6665L17.5 7.49984V16.6665C17.5 17.1085 17.3244 17.5325 17.0118 17.845C16.6993 18.1576 16.2754 18.3332 15.8333 18.3332H4.16667C3.72464 18.3332 3.30072 18.1576 2.98816 17.845C2.67559 17.5325 2.5 17.1085 2.5 16.6665V7.49984Z" stroke="#222222" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.5 18.3333V10H12.5V18.3333" stroke="#222222" stroke-linecap="round" stroke-linejoin="round"/></svg>Hotels</a></li>
        ...
        <?php if(session()->has('frontend_user')): ?> 
        <div class="tr-actions">
            <button class="tr-btn tr-write-review"><a href="<?php echo e(route('userlogout')); ?>">Logout</a></button>
          </div>

     
          <?php else: ?>
          <div class="tr-actions">
            <button class="tr-btn tr-write-review" data-bs-toggle="modal" data-bs-target="#signInModal">Sign up / Log in</button>
          </div>
          <?php endif; ?>
      </div>
    </div><?php /**PATH C:\wamp64\www\tavelll\resources\views/frontend/mobile_nav.blade.php ENDPATH**/ ?>