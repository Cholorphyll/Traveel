...
<div class="tr-tourist-place-lists">
  ...
  <div class="tr-tourist-place">
    <div class="tr-img">
      <picture>
        <source srcset="<?php echo e(asset('frontend/hotel-detail/images/tourist-places-1.webp')); ?>" type="image/webp">
        <img
            src="<?php echo e(asset('frontend/hotel-detail/images/tourist-places-1.webp')); ?>"
            alt="tourist-places"
            width="120"
            height="81"
            class="lcp-image"
    ...
    <div class="tr-details">
      <div class="tr-place-name"><a
          href="<?php echo e(route('sight.details',[$nearbyatt->LocationId.'-'.$nearbyatt->SightId.'-'.$nearbyatt->Slug])); ?>"><?php echo e($nearbyatt->Title); ?></a>
      </div>
      <div class="tr-place-type"><?php echo e($nearbyatt->ctitle); ?></div>
  ...
  <?php for($i = $nearbyattCount; $i < 4; $i++): ?> <!-- Placeholder elements when less than 4 items are available -->
    <div class="tr-tourist-place">
      <div class="tr-img">
    ...
    <?php for($i = 0; $i < 4; $i++): ?> <div class="tr-tourist-place">
      <div class="tr-img">
        <img loading="lazy" src="<?php echo e(asset('frontend/hotel-detail/images/no-data-explore.png')); ?>" alt="no-data">
      </div>
      <div class="tr-details">
...
<?php endfor; ?>
<?php endif; ?>
</div><?php /**PATH C:\wamp64\www\tavelll\resources\views/explore_results/nearby_attraction.blade.php ENDPATH**/ ?>