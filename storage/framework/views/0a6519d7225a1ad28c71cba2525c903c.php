...
<div class="tr-nearby-hotel-list">
  <div class="tr-hotel-img">
    <a href="javascript:void(0):">
      <img loading="lazy" src="https://photo.hotellook.com/image_v2/limit/h<?php echo e($nearby_hotels->hotel_id); ?>_1/376/291.jpg"
  ...
  <div class="tr-hotel-deatils">
    <div class="tr-hotel-name"><a
        href="<?php echo e(route('hotel.detail',[$nearby_hotels->location_id.'-'.$nearby_hotels->hotelid.'-'.$nearby_hotels->slug])); ?>"><?php echo e($nearby_hotels->name); ?></a>
    </div>
    ...
    <div class="tr-price-section"><span>$<?php echo e($nearby_hotels->pricefrom); ?></span> /night</div>
    <?php endif; ?>
  </div>
</div>
<?php if($nearby_hotel->count() < 4): ?> <?php for($i=0; $i < 4 - $nearby_hotel->count(); $i++): ?>
  <div class="tr-nearby-hotel-list">
    <div class="tr-hotel-img">
      <img loading="lazy" src="<?php echo e(asset('frontend/hotel-detail/images/no-data-nearby-hotel.png')); ?>"
        alt="NearBy Hotel">
    </div>
    <div class="tr-hotel-deatils">
  ...
  <?php for($i = 0; $i < 4; $i++): ?> <div class="tr-nearby-hotel-list">
    <div class="tr-hotel-img">
      <img loading="lazy" src="<?php echo e(asset('frontend/hotel-detail/images/no-data-nearby-hotel.png')); ?>"
        alt="NearBy Hotel">
    </div>
    ...
    <?php endfor; ?>
    <?php endif; ?><?php /**PATH C:\wamp64\www\tavelll\resources\views/explore_results/sight_nearby_hotels.blade.php ENDPATH**/ ?>