...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/frontend/hotel-detail/js/slick.min.js')); ?>"></script>

    <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/bootstrap.min.css')); ?>?v=<?php echo e(filemtime(public_path('frontend/hotel-detail/css/bootstrap.min.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/style.css')); ?>?v=<?php echo e(filemtime(public_path('frontend/hotel-detail/css/style.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/calendar.css')); ?>?v=<?php echo e(filemtime(public_path('frontend/hotel-detail/css/calendar.css'))); ?>" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/slick.css')); ?>?v=<?php echo e(filemtime(public_path('frontend/hotel-detail/css/slick.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/responsive.css')); ?>?v=<?php echo e(filemtime(public_path('frontend/hotel-detail/css/responsive.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/custom.css')); ?>?v=<?php echo e(filemtime(public_path('frontend/hotel-detail/css/custom.css'))); ?>">
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css">

    <link rel="stylesheet" href="<?php echo e(asset('/explore/css/bootstrap.min.css')); ?>?v=<?php echo e(filemtime(public_path('explore/css/bootstrap.min.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/explore/css/style.css')); ?>?v=<?php echo e(filemtime(public_path('explore/css/style.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/explore/css/calendar.css')); ?>?v=<?php echo e(filemtime(public_path('explore/css/calendar.css'))); ?>" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('/explore/css/slick.css')); ?>?v=<?php echo e(filemtime(public_path('explore/css/slick.css'))); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/explore/css/responsive.css')); ?>?v=<?php echo e(filemtime(public_path('explore/css/responsive.css'))); ?>">
        ...
        <div class="tr-explore-listing">  
          <div class="tr-explore-left-section">
            ...
            <div class="search__Section">
              <form method="GET" action="<?php echo e(route('searchlist')); ?>">
                <span class="tr-search-icon"><i class="fa fa-search" aria-hidden="true"></i></span>
                <input type="hidden" name="locId" value="<?php echo e($location_id ?? ''); ?>"/>
                <input type="hidden" name="slugid" value="<?php echo e($location_slugid ?? ''); ?>"/>
                <input type="text" id="search" name="q" required placeholder="Search restaurants" value="<?php echo e($search_query ?? ''); ?>"/>
              </form>
            </div>

            <?php if(($restaurants instanceof \Illuminate\Support\Collection ? $restaurants->count() : count($restaurants)) > 0): ?>
                    ...
                    <div class="Container__Section space8">
                      <div class="card__gallerySection">
                        <div class="card__thumb">
                          <?php if(!empty($r->Img1)): ?>
                            <img src="<?php echo e($r->Img1); ?>" alt="">
                          <?php else: ?>
                            <img src="<?php echo e(asset('explore/images/London/SukhnaLake.jpg')); ?>" alt="">
                          <?php endif; ?>
                          <span><img src="<?php echo e(asset('explore/images/icons/bookmark.svg')); ?>" alt=""></span>
                        </div>
                      </div>
                      <div class="left__sideSection ad__Space">
                        <div class="card__Subtitle">
                          <?php if(!empty($rId) && !empty($rSlugId)): ?>
                            <h5><a href="<?php echo e(url('/rd-' . $rSlugId . '-' . $rId . '-' . ($rSlug ?: \Illuminate\Support\Str::slug($rTitle)))); ?>"><?php echo e($rTitle); ?></a></h5>
                          <?php else: ?>
                            <h5><?php echo e($rTitle); ?></h5>
                          <?php endif; ?>
                        </div>
                        <?php if(!empty($r->Address)): ?>
                        <div class="card__listSection">
                          <div class="card__details update_details">
                            <span><?php echo e($r->Address); ?></span>
                          </div>
                        </div>
                        <?php endif; ?>
                        <?php if(!empty($r->Cuisines)): ?>
                        <div class="card__listSection">
                          <div class="card__details">
                            <span><?php echo e($r->Cuisines); ?></span>
                          </div>
                        </div>
                        <?php endif; ?>
                        <?php if(!empty($r->Cost)): ?>
            ...
            <?php else: ?>
              ...
              ?>
              <?php $__currentLoopData = $dummyRestaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dummyTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card__Container">
                  <div class="card__Box">
                    <div class="card__title">
                      <h6>Restaurant</h6>
                    ...
                    <div class="Container__Section space8">
                      ...
                      <div class="left__sideSection ad__Space">
                        <div class="card__Subtitle">
                          <h5><?php echo e($dummyTitle); ?></h5>
                        </div>
                        <div class="card__listSection">
                          <div class="card__details">
                            <span><img src="<?php echo e(asset('explore/images/icons/heart.svg')); ?>" alt=""></span>
                            <span>89%</span>
                          </div>
                        </div>
                        <div class="card__listSection">
                          ...
                          <div class="card__details update_details">
                            <span><img src="<?php echo e(asset('explore/images/icons/point.svg')); ?>" alt=""></span>
                            <span>&bull; 5 hours</span>
                          </div>
                        </div>
                        <div class="card__listSection">
                          <div class="card__details">
                            <span><img src="<?php echo e(asset('explore/images/icons/globel.svg')); ?>" alt=""></span>
                            <span>Speaks English</span>
                          </div>
                          <div class="card__details">
                            <span><img src="<?php echo e(asset('explore/images/icons/wifi.svg')); ?>" alt=""></span>
                            <span> Free WIFI </span>
                          </div>
                        </div>
                        <div class="card__listSection">
                          <div class="card__details">
                            <span><img src="<?php echo e(asset('explore/images/icons/close.svg')); ?>" alt=""></span>
                            <span>Takeout</span>
                          </div>
                          <div class="card__details">
                            <span><img src="<?php echo e(asset('explore/images/icons/tick.svg')); ?>" alt=""></span>
                            <span> Seating </span>
                          </div>
                          <div class="card__details">
                            <span><img src="<?php echo e(asset('explore/images/icons/tick.svg')); ?>" alt=""></span>
...
</html><?php /**PATH C:\wamp64\www\tavelll\resources\views/searchlist.blade.php ENDPATH**/ ?>