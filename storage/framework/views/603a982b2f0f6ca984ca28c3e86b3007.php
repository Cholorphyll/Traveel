...
<script>
  ...
  gtag('config', 'G-3G0VLZYF7R');
   ...
   <?php $title = '';$lname=''; ?>
<?php if(!empty($searchresult)): ?> <?php $title = $searchresult[0]->MetaTagTitle; $MetaTagDescription = $searchresult[0]->MetaTagDescription; $lname=$searchresult[0]->Name; ?> <?php endif; ?>
 <title>
    <?php if(!empty($title)): ?>
        <?php echo e($title); ?> - Travell (2025)
    <?php if(!empty($locationPatent) && is_array($locationPatent)): ?>
    ...
    <?php endif; ?>
    <?php else: ?>
        <?php if(!empty($searchresult)): ?><?php echo e($searchresult[0]->Title); ?>, <?php echo e($searchresult[0]->Name); ?><?php endif; ?> – Reviews, Hours, and Photos - Travell (2025)
    ...
    <meta name="description" content="<?php if(!empty($MetaTagDescription)): ?><?php echo e($MetaTagDescription); ?><?php elseif(!empty($searchresult)): ?>Explore <?php echo e($searchresult[0]->Title); ?> in <?php echo e($searchresult[0]->Name); ?> with detailed visitor reviews, operational hours, and contact information. Everything you need to know to plan a memorable visit is here.<?php else: ?> Explore attractions with detailed visitor reviews, operational hours, and contact information. Everything you need to know to plan a memorable visit is here.<?php endif; ?>">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
   <?php if(session('frontend_user') && isset(session('frontend_user')['UserId'])): ?>
    <meta name="user-id" content="<?php echo e(session('frontend_user')['UserId']); ?>">
    <?php else: ?>
        <meta name="user-id" content="0"> <!-- Or handle guest users appropriately -->
    <?php endif; ?>
  ...
  <script src="<?php echo e(asset('js/cookie-consent.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/frontend/hotel-detail/js/jquery.min.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(asset('/frontend/hotel-detail/js/bootstrap.bundle.min.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(asset('/frontend/hotel-detail/js/jquery-ui-datepicker.min.js')); ?>">
  </script>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/calendar.css')); ?>" media="screen">
  <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/responsive.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('/frontend/hotel-detail/css/custom.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('/css/map_leaflet.css')); ?>">
<style>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "<?php echo e($searchresult[0]->Title); ?>",
      "description": "<?php echo e(strip_tags(str_replace('\n', ' ', $searchresult[0]->About))); ?>",
      "url": "<?php echo e(url()->current()); ?>",
      <?php if(isset($Sight_image) && !$Sight_image->isEmpty()): ?>
      "image": [
        <?php $__currentLoopData = $Sight_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(isset($image->Image) && $image->Image != ''): ?>
        "https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($image->Image); ?>"<?php if(!$loop->last): ?>,<?php endif; ?>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ],
      <?php endif; ?>
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "<?php echo e($searchresult[0]->Address); ?>",
        <?php if(!empty($locationPatent)): ?>
         "addressLocality": "<?php echo e($searchresult[0]->Name ?? ($locationPatent[0]['Name'] ?? '')); ?>",
        <?php endif; ?>
        <?php if(!empty($breadcumb) && $breadcumb[0]->CountryName != ""): ?>
        "addressCountry": "<?php echo e($breadcumb[0]->CountryName); ?>"
        <?php endif; ?>
      },
      <?php if($searchresult[0]->Longitude != "" && $searchresult[0]->Latitude != ""): ?>
      "geo": {
        "@type": "GeoCoordinates",
        "latitude": "<?php echo e($searchresult[0]->Latitude); ?>",
        "longitude": "<?php echo e($searchresult[0]->Longitude); ?>"
      },
      <?php endif; ?>
      <?php if($searchresult[0]->Phone != ""): ?>
      "telephone": "<?php echo e($searchresult[0]->Phone); ?>",
      <?php endif; ?>
      <?php if(!empty($gettiming) && count($gettiming) > 0): ?>
      "openingHoursSpecification": [
        ...
        $firstDay = true;
        ?>
        <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayKey => $dayName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(isset($data[$dayKey]) && isset($data[$dayKey]['open']) && isset($data[$dayKey]['close'])): ?>
        <?php if(!$firstDay): ?>,<?php endif; ?>
        {
          "@type": "OpeningHoursSpecification",
          "dayOfWeek": "<?php echo e($dayName); ?>",
          "opens": "<?php echo e($data[$dayKey]['open']); ?>",
          "closes": "<?php echo e($data[$dayKey]['close']); ?>"
        }
        <?php $firstDay = false; ?>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php endif; ?>
      <?php if($searchresult[0]->Website != ""): ?>
      "sameAs": "<?php echo e($searchresult[0]->Website); ?>",
      <?php endif; ?>
 <?php if($searchresult[0]->Averagerating != "" && $searchresult[0]->Averagerating != 0 && !empty($sightreviews) && count($sightreviews) > 0): ?>
      "aggregateRating": {
        "@type": "AggregateRating",
        "ratingValue": "<?php echo e($searchresult[0]->Averagerating); ?>",
        "reviewCount": "<?php echo e(count($sightreviews)); ?>",
        "bestRating": "100"
      },
      <?php endif; ?>
      <?php if(!empty($sightreviews)): ?>
      "review": [
        <?php $__currentLoopData = $sightreviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($key < 5): ?>
        {
          "@type": "Review",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "<?php echo e($review->IsRecommend == 1 ? '5' : '1'); ?>",
            "bestRating": "100"
          },
          "author": {
            "@type": "Person",
            "name": "<?php echo e($review->FirstName); ?>"
          },
          "reviewBody": "<?php echo e(strip_tags(str_replace('\n', ' ', $review->ReviewDescription))); ?>"
        }<?php if($key < 4 && $key < count($sightreviews) - 1): ?>,<?php endif; ?>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ],
      <?php endif; ?>
    ...
    },
    {
      ...
      "primaryImageOfPage": {
        "@type": "ImageObject",
        <?php if(isset($Sight_image) && !$Sight_image->isEmpty() && isset($Sight_image[0]->Image) && $Sight_image[0]->Image != ''): ?>
        "url": "https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($Sight_image[0]->Image); ?>"
        <?php else: ?>
        "url": "<?php echo e(asset('/frontend/hotel-detail/images/no-data-place-image.png')); ?>"
        <?php endif; ?>
      },
    ...
    },
    {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://www.travell.co.in/images/logo.png"
      }
    }
  ]
}
            ...
            <div class="tr-explore-galleries">
              <div class="tr-desktop d-none d-sm-block d-md-block">
                <div class="tr-thumb-images">
                  <ul>    
                  <?php if( isset($Sight_image[0]->Image) && $Sight_image[0]->Image !=''): ?>             
                    <li>                                         <?php if(str_contains($Sight_image[0]->Image, 'vid')): ?>
                            <video class="gallery-video" style="width: 608px; height: 445px; object-fit: cover;" controls muted autoplay loop playsinline>
                                <source src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($Sight_image[0]->Image); ?>" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        <?php else: ?>
                            <img src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($Sight_image[0]->Image); ?>" alt="<?php echo e($searchresult[0]->Title); ?>" height="445" width="608">
                        <?php endif; ?>
                    </li>
                    <?php else: ?>
                    <!-- Below element When We dont have data - Start -->
                    <div >
                      <img src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-place-image.png')); ?>" alt="">      
                    </div>
                    ...
                    <?php if(!$Sight_image->isEmpty() && $Sight_image->count() > 1): ?>
                    <?php                         
                          $remainingImages = $Sight_image->slice(1);
                      ?>

                      <?php if(!$remainingImages->isEmpty()): ?>
                          <?php $__currentLoopData = $remainingImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li>
                                   <?php if(str_contains($image->Image, 'vid')): ?>
                                       <video class="gallery-video" style="width: 110px; height: 115px; object-fit: cover;" controls muted autoplay loop playsinline>
                                           <source src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($image->Image); ?>" type="video/mp4">
                                           Your browser does not support the video tag.
                                       </video>
                                   <?php else: ?>
                                       <img src="<?php if(isset($image->Image) && $image->Image != ''): ?>                                 
                                                https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($image->Image); ?>                                        
                                           <?php endif; ?>" 
                                       alt="<?php echo e($searchresult[0]->Title); ?>" height="115" width="110">
                                   <?php endif; ?>
                              </li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php if(count($Sight_image) < 5): ?> 
                            <?php for($i=0; $i < 6 - count($Sight_image); $i++): ?>
                              <li>
                                    <img src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-place-image.png')); ?>" 
              ...
              <?php if(!$Sight_image->isEmpty()): ?>
              <?php  $tsightimg =  count($Sight_image) - 1  ?>
                        <a href="javascript:void(0);" class="tr-show-all-photos" <?php if($tsightimg ==0): ?> style="height: 41px;
    width: 48px;" <?php endif; ?>><?php if($tsightimg ==0): ?> Gallery View <?php else: ?> + <?php echo e($tsightimg); ?> <?php endif; ?></a>
              <?php endif; ?>
                </div>
              </div>
                ...
                <?php if(!$Sight_image->isEmpty() && $Sight_image->count() > 1): ?>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                       <img src="<?php if( isset($Sight_image[0]->Image) && $Sight_image[0]->Image !=''): ?>  https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($Sight_image[0]->Image); ?>  <?php else: ?> <?php echo e(asset('/frontend/hotel-detail/images/no-data-place-image.png')); ?> <?php endif; ?> " alt="Tower Bridge" class="d-block w-100" height="452" width="432">                    
                    </div>
                      ...
                      <?php if(!$remainingImages->isEmpty()): ?>
                          ...
                          <img src="<?php if(isset($image->Image) && $image->Image != ''): ?> 
                              https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($image->Image); ?>
                                          ...
                                          <?php endif; ?>" alt="" class="d-block w-100" height="452" width="432">
                        </div>                             
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php endif; ?>
                    <?php endif; ?>
                  ...
                  <div class="carousel-thumbs">
                    ...
                    <div class="tr-thumbs-count tr-show-all-photos">Show all <?php echo e($tsightimg); ?>+</div>
          ...
          <div class="col-lg-6 col-md-12 tr-left-col">
            <div class="tr-hotel-informations">
              <div class="tr-hotel-info">
                <div class="tr-place-name">
                  <h1 class="tr-hotel-name"><?php echo e($searchresult[0]->Title); ?></h1>
                  <?php if($searchresult[0]->IsMustSee == 1): ?>
                  <span class="d-none d-sm-block d-md-block">Must see</span>
                  <?php endif; ?>
                </div>
                <div class="tr-hotel-address"><?php echo e($searchresult[0]->Address); ?></div>
                <input type="hidden" value="<?php echo e($searchresult[0]->SightId); ?>" id="sightId">
                <input type="hidden" id="LocationId" value="<?php echo e($searchresult[0]->LocationId); ?>">
                <span class="d-none sightId"><?php echo e($searchresult[0]->SightId); ?></span>
                <span class="d-none Longitude"><?php echo e($searchresult[0]->Longitude); ?></span>
                <span class="d-none Latitude"><?php echo e($searchresult[0]->Latitude); ?></span>
            ...
            <?php   $ratingtext = '';
                          $color = ''; ?>
            <?php if($searchresult[0]->Averagerating != "" && $searchresult[0]->Averagerating != 0): ?>
                    <?php 
  ...
  $result = $rating; // Using direct rating value without multiplication
                ...
                ?>
                      <?php echo e($result); ?>% <?php else: ?> -- <?php endif; ?></div>
                      <?php if($searchresult[0]->Averagerating != "" && $searchresult[0]->Averagerating != 0): ?>     <div class="tr-review-name tr-excellent" style="color:<?php echo e($color); ?>"><?php echo e($ratingtext); ?></div> <?php endif; ?>
                  </div>
            ...
            <?php if($searchresult[0]->Award == 1): ?>
            <div class="tr-hotel-certificated">
              <div class="tr-families-favourite">
                <div>
                  <img src="<?php echo e(asset('/frontend/hotel-detail/images/leaf.png')); ?>" alt="leaf">
                  <span>Travellers Favorite</span>
                </div>
                <?php if($searchresult[0]->Award_description != ""): ?>  <p><?php echo e($searchresult[0]->Award_description); ?></p><?php endif; ?>
              </div>
            </div>
            <?php endif; ?>
            ...
            <div class="tr-about-section">
              <div class="tr-overview-section">
                ...
                ?>
                    <li>
  <div class="tr-rating"><?php echo e($searchresult[0]->Averagerating); ?></div>
  <div class="tr-rating-type"><?php echo e($ratingtext); ?></div>
  <?php if(count($sightreviews) != 0): ?>
    <div class="tr-review"><?php echo e(count($sightreviews)); ?> review</div>
  <?php endif; ?>
</li>
<?php if($searchresult[0]->duration != ""): ?>
<li>
  <div class="tr-rating"><?php echo e($searchresult[0]->duration); ?></div>
  <div class="tr-rating-type">hours</div>
  <div class="tr-review">DURATION</div>
</li>
<?php endif; ?>
<?php if(!$gettiming->isEmpty()): ?>
<?php
...
<li>
  <div class="tr-rating">
    ...
    <?php if($todayStartTime && $todayEndTime): ?>
      <div><?php echo e(date('h:i A', $todayStartTime)); ?> - <?php echo e(date('h:i A', $todayEndTime)); ?></div>
    <?php else: ?>
...
<?php endif; ?>
              ...
              <div class="tr-about">
                <div class="tr-overview-content">
                  <p class="tr-content"><?php echo e($searchresult[0]->About); ?></p>
              ...
              <?php else: ?>
                ...
                <div class="mt-41">
                    <img src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-about.png')); ?>" alt="">
            ...
            <?php if(!empty($searchresult[0]->best_for) || !empty($searchresult[0]->best_season) || !empty($searchresult[0]->best_time_to_visit)): ?>
            <div class="best__Component">
              <?php if(!empty($searchresult[0]->best_for)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Bestfor.svg" alt=""></div>
                <div class="best__ComponentDetails">
                  <h4>Best for</h4>
                  <p><?php echo e($searchresult[0]->best_for); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->best_season)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Bestseason.svg" alt=""></div>
                <div class="best__ComponentDetails">
                  <h4>Best season</h4>
                  <p><?php echo e($searchresult[0]->best_season); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->best_time_to_visit)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Besttime.svg" alt=""></div>
                <div class="best__ComponentDetails">
                  <h4>Best time to visit</h4>
                  <p><?php echo e($searchresult[0]->best_time_to_visit); ?></p>
                </div>
              </div>
              <?php endif; ?>
            </div>
                ...
                <div class="col-sm-12">
                  <div class="tr-customer-highlighted-reviews">
                    <div class="tr-customer-review">
                      ...
                      <!--p><?php if(!empty($tips_reviews)): ?>
    <?php $__currentLoopData = $tips_reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="username"><?php echo e($tip->username); ?></div>
            <div class="review-text"><?php echo e($tip->review); ?></div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?></p-->
                    </div>
</div>
            ...
            <!-- Accessibility -->
            <?php if(!empty($searchresult[0]->accessibility) || !empty($searchresult[0]->kid_friendly) || !empty($searchresult[0]->pet_friendly) || !empty($searchresult[0]->food_facilities) || !empty($searchresult[0]->public_restrooms) || !empty($searchresult[0]->parking_facilities)): ?>
            <div class="best__Component">
              <?php if(!empty($searchresult[0]->accessibility)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section mt1"><img src="images/Accessibility.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Accessibility</h4>
                  <p><?php echo e($searchresult[0]->accessibility); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->kid_friendly)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section mt1"><img src="images/Kidfriendly.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Kid friendly</h4>
                  <p><?php echo e($searchresult[0]->kid_friendly); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->pet_friendly)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Petfriendly.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Pet friendly</h4>
                  <p><?php echo e($searchresult[0]->pet_friendly); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->food_facilities)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/foodfacilities.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Food facilities/restaurants/cafes</h4>
                  <p><?php echo e($searchresult[0]->food_facilities); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->public_restrooms)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Publicrestrooms.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Public restrooms</h4>
                  <p><?php echo e($searchresult[0]->public_restrooms); ?></p>
                </div>
              </div>
              <?php endif; ?>
              <?php if(!empty($searchresult[0]->parking_facilities)): ?>
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Parking.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Parking facilities</h4>
                  <p><?php echo e($searchresult[0]->parking_facilities); ?></p>
                </div>
              </div>
              <?php endif; ?>
            </div>
            ...
            <!--div class="tr-recommended-write-review">
              ...
              <div class="tr-details">
                <p>Do you recommend visiting <?php echo e($searchresult[0]->Title); ?>?</p>
            ...
            <!-- <div class="tr-about-founder">
              ...
              <div class="tr-founder-details">
                <div class="tr-image">
              <img src="<?php if( isset($Sight_image[0]->Image) && $Sight_image[0]->Image !=''): ?> <?php echo e(asset('/sight-images/'. $Sight_image[0]->Image)); ?> <?php else: ?> <?php echo e(asset('/images/Hotel lobby.svg')); ?> <?php endif; ?>" alt="founder-tower-bridge">
                </div>
                <div class="tr-details">
                  <div class="tr-overview-content">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="tr-top-ways-section">
              <h3>Top ways to experience <?php echo e($searchresult[0]->Title); ?></h3>
              <div class="tr-top-ways-lists" id="">

               <?php if(!$get_experience->isEmpty()): ?>
                    <?php
                      $experienceCount = count($get_experience);
                      $requiredPlaceholders = 4 - $experienceCount;
                    ?>
                    
                    <?php $__currentLoopData = $get_experience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $get_experiences): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="tr-top-ways-list">
                       
                        <div class="tr-details">
                          <div class="tr-place-type">Classes</div>
                          <div class="tr-place-name">
                            <a href="<?php echo e(route('experince', [$get_experiences->slugid . '-' . $get_experiences->ExperienceId . '-' . $get_experiences->Slug])); ?>">
                              <?php echo e($get_experiences->Name); ?>
                          ...
                          <div class="tr-like-review">
                            <span class="tr-likes">
                              ...
                              <?php if($get_experiences->TAAggregationRating !=""): ?>
                              <?php $exprat = (float)$get_experiences->TAAggregationRating;
                                    $exprating = round($exprat * 20);
                              ?>
                              <?php echo e($exprating); ?> <?php else: ?> -- <?php endif; ?>%
                            </span>
                            <span class="tr-review">(<?php echo e($get_experiences->review_count); ?> reviews)</span>
                          </div>
                          <?php if($get_experiences->Cost != ""): ?>
                          <div class="tr-price-section"><?php echo e($get_experiences->Cost); ?></div>
                          <?php endif; ?>
                        </div>
                      </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php for($i = 0; $i < $requiredPlaceholders; $i++): ?>
                    <div class="tr-top-ways-list">
                        <div class="tr-img">
                          <img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/top-way-no-data.png')); ?>" alt="top-places">
                        </div>
                        <div class="tr-details">
                          <div class="tr-no-data-text w-100 mb-12"></div>
                          <div class="tr-no-data-text w-60 mb-12"></div>
            ...
            <div class="tr-Location-section tr-tab-section">
              ...
              <div class="tr-Location-details">
                <ul>
                  <li class="tr-location-address"><?php if($searchresult[0]->Address != ""): ?> <?php echo e($searchresult[0]->Address); ?>

                  <?php else: ?>  Add location information <?php endif; ?></li>
                  <li class="tr-phone">  <?php if($searchresult[0]->Phone != ""): ?> <?php echo e($searchresult[0]->Phone); ?>

                  <?php else: ?> Add phone number <?php endif; ?></li>
                  <!-- <li class="tr-email">towerbridge@gmail.com</li> -->
                  <li class="tr-website-link"><a href='<?php if($searchresult[0]->Website != ""): ?> <?php echo e($searchresult[0]->Website); ?> <?php endif; ?>' target="_blank">Visit website</a></li>
                </ul>
              </div>
              <div class="tr-location-map">
                ...
                <?php else: ?> 
                  <div >
                    <img src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-no-map.png')); ?>" alt="">
          ...
          <!--EXPLORE OTHER OPTIONS IN AND AROUND SECTION - START-->
              ...
              <div class="tr-tourist-places-row" >
                ...
                <div class="tr-tourist-places" id="nearbyattraction">
                  ...
                  <div class="tr-tourist-place-lists">
                    <!-- new data -->
                    <?php if(!$nearbyatt->isEmpty()): ?>
                          <?php
                            $nearbyCount = count($nearbyatt);
                            $requiredPlaceholders = 4 - $nearbyCount;
                          ?>
                          
                          <?php $__currentLoopData = $nearbyatt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nearbyatt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tr-tourist-place">
                              <div class="tr-img">
                                <a href="javascript:void(0);">
                                  <img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/tourist-places-1.png')); ?>" alt="tourist-places" class="lcp-image">
                                </a>
                              </div>
                              <div class="tr-details">
                                <div class="tr-place-name">
                                  <a href="<?php echo e(route('sight.details', [$nearbyatt->LocationId . '-' . $nearbyatt->SightId . '-' . $nearbyatt->Slug])); ?>">
                                    <?php echo e($nearbyatt->Title); ?>

                                  </a>
                                </div>
                                <div class="tr-place-type jjjjjj"><?php echo e($nearbyatt->ctitle); ?></div>
                                <div class="tr-like-review">
                                  <?php if($nearbyatt->TAAggregateRating != "" && $nearbyatt->TAAggregateRating != 0): ?>
                                    <?php $result = rtrim($nearbyatt->TAAggregateRating, '.0') * 20; ?>
                                    <span class="tr-likes"><?php echo e($result); ?>%</span>
                                  <?php endif; ?>
                                </div>
                                <div class="tr-distance"><?php echo e($nearbyatt->distance); ?> km</div>
                              </div>
                            </div>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <?php for($i = 0; $i < $requiredPlaceholders; $i++): ?>
                            <div class="tr-tourist-place">
                              <div class="tr-img">
                                <img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-explore.png')); ?>" alt="tourist-places">
                              </div>
                              <div class="tr-details">
                                <div class="tr-no-data-text w-100 mb-12"></div>
                                <div class="tr-no-data-text w-60 mb-12"></div>
                    ...
                    <?php $__currentLoopData = $get_nearby_rest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="tr-tourist-place">
                        ...
                        <div class="tr-details">
                          ...
                          <div class="tr-like-review">
                            <?php if($val->TATrendingScore != "" && $val->TATrendingScore != 0): ?>
                              <?php $result = rtrim($val->TATrendingScore, '.0') * 10; ?>
                              <span class="tr-likes"><?php echo e($result); ?>%</span>
                            <?php endif; ?>
                            <span class="tr-review"> .<?php echo e($val->review_count); ?> reviews</span>
                          </div>
                          <div class="tr-distance"><?php echo e(number_format($val->distance, 2)); ?> km</div>
                        </div>
                      </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(!empty($searchresult[0]->packing_checklist) || !empty($searchresult[0]->what_people_like) || !empty($searchresult[0]->what_people_dont_like) || !empty($searchresult[0]->what_to_do) || !empty($searchresult[0]->what_not_to_do)): ?>
            <section class="py-5 checkSection">
              <div class="row">
                <?php if(!empty($searchresult[0]->packing_checklist)): ?>
                <div class="col-md-4">
                  <div class="checklist__box">
                    <h4>Packing checklist</h4>
                    <?php echo $searchresult[0]->packing_checklist; ?>

                  </div>
                </div>
                <?php endif; ?>

                <?php if(!empty($searchresult[0]->what_people_like) || !empty($searchresult[0]->what_people_dont_like)): ?>
                <div class="col-md-4 <?php if(!empty($searchresult[0]->packing_checklist)): ?> LeftSideBorder <?php endif; ?>">
                  <?php if(!empty($searchresult[0]->what_people_like)): ?>
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/likeicon.svg" alt=""></div>
                    <div>
                      <h5>What people like</h5>
                      <?php echo $searchresult[0]->what_people_like; ?>

                    </div>
                  </div>
                  <?php endif; ?>
                  <?php if(!empty($searchresult[0]->what_people_dont_like)): ?>
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/dislike.svg" alt=""></div>
                    <div>
                      <h5>What don't people like</h5>
                      <?php echo $searchresult[0]->what_people_dont_like; ?>
                ...
                <?php if(!empty($searchresult[0]->what_to_do) || !empty($searchresult[0]->what_not_to_do)): ?>
                <div class="col-md-4 LeftSideBorder">
                  <?php if(!empty($searchresult[0]->what_to_do)): ?>
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/do.svg" alt=""></div>
                    <div>
                      <h5>DO</h5>
                      <?php echo $searchresult[0]->what_to_do; ?>

                    </div>
                  </div>
                  <?php endif; ?>
                  <?php if(!empty($searchresult[0]->what_not_to_do)): ?>
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/dont.svg" alt=""></div>
                    <div>
                      <h5>DON'T</h5>
                      <?php echo $searchresult[0]->what_not_to_do; ?>
            ...
            <!-- Best photo spots -->
            <section class="py-5 bestphoto">
              <h2>Best photo spots</h2>
              <div class="row">
                <div class="col-md-4">
                  <img src="images/gallery-img-1.png" alt="" />
                  <h3>Shoot from Zabeel Park ground level for symmetry</h3>
                </div>
                <div class="col-md-4">
                  <img src="images/gallery-img-2.png" alt="" />
                  <h3>Shoot from the glass floor Look straight down for a unique perspective of the ground below.</h3>
                </div>
                <div class="col-md-4">
            ...
            <div class="tr-nearby-hotel">
              ...
              <div class="row tr-nearby-hotel-lists" id="nearby_hotel">               
                 <?php if(!$nearby_hotel->isEmpty()): ?>
                      <?php $__currentLoopData = $nearby_hotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nearby_hotels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="tr-nearby-hotel-list">
                              <div class="tr-hotel-img">
                                  <a href="javascript:void(0);">
                                      <img loading="lazy" src="https://photo.hotellook.com/image_v2/limit/h<?php echo e($nearby_hotels->hotel_id); ?>_1/290/291.jpg" alt="NearBy Hotel" height="290" width="291" onerror="this.onerror=null;this.src='https://www.travell.co.in/frontend/hotel-detail/images/Hotel%20lobby-image.png';">
                                  </a>
                                   
                              </div>
                              <div class="tr-hotel-deatils">
                                  <div class="tr-hotel-name">
                                      <a href="<?php echo e(route('hotel.detail', [$nearby_hotels->location_id.'-'.$nearby_hotels->hotelid.'-'.$nearby_hotels->slug])); ?>">
                                          <?php echo e($nearby_hotels->name); ?>
                                  ...
                                  <div class="tr-like-review">
                                      ...
                                      <?php if($nearby_hotels->stars != "" && $nearby_hotels->stars != 0): ?>
                                          <?php
                                          ...
                                          <span class="tr-vgood" style="color:<?php echo e($color); ?>"><?php echo e($ratingtext); ?></span>
                                      <?php endif; ?>
                                  </div>
                                  <?php if($nearby_hotels->pricefrom != ""): ?>
                                      <div class="tr-price-section">
                                          <span>$<?php echo e($nearby_hotels->pricefrom); ?></span> /night
                                      </div>
                                  <?php endif; ?>
                              </div>
                          </div>
                      ...
                      <?php if($nearby_hotel->count() < 4): ?>
                          <?php for($i = 0; $i < 4 - $nearby_hotel->count(); $i++): ?>
                          <div class="tr-nearby-hotel-list">
                                    <div class="tr-hotel-img">
                                      <img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-nearby-hotel.png')); ?>" alt="NearBy Hotel">
                                    </div>
                                    <div class="tr-hotel-deatils">
                                      <div class="tr-no-data-text w-100 mb-12"></div>
            ...
            <div class="tr-review-section" id="">
              <div class="row">              
                <h3>What travellers say about <?php echo e($searchresult[0]->Title); ?></h3>
                <div class="col-lg-7 getreviewdata" id="reviews">          
                  <div class="tr-review-content">
            <?php if($searchresult[0]->ReviewSummaryLabel !=""): ?>
                    <div class="tr-power-by">
            
                      <ul>
                        <li><img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/ellipse-1.png')); ?>" alt="ellipse"></li>
                        <li><img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/ellipse-2.png')); ?>" alt="ellipse"></li>
                        <li><img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/ellipse-3.png')); ?>" alt="ellipse"></li>
                        <li>
                          <img loading="lazy" src="<?php echo e(asset('/frontend/hotel-detail/images/ellipse-4.png')); ?>" alt="ellipse">
                    ...
                    <ul class="tr-revies-recomm">
                      <?php $__currentLoopData = $expreviewSummaryLabel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sumval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if( $t ==1): ?>
                    ...
                    <?php endif; ?>
                   <?php if($searchresult[0]->ReviewSummary !=""): ?> <p><?php echo e($searchresult[0]->ReviewSummary); ?></p><?php endif; ?>
                  
                   <?php if(!$sightreviews->isEmpty()): ?> <a href="javascript:void(0);" class="tr-jump-to-all-review">Jump to all reviews</a>
           ...
           <?php
            ...
            ?>
                      <div class="tr-reviews-graph">
                        <div class="tr-reviews-graph-details">
                          <h4 class="d-none d-md-block">Travellers Reviews</h4>
                            <div class="tr-likes-count review-rating-count"><?php echo e(floor($averageRatingPercentage)); ?>%</div>
                          <div class="tr-no-review" data-type="no-data">No Review</div>
                          <div class="tr-reviews-count">(<?php echo e(count($sightreviews)); ?> Reviews)</div>
                        </div>
                        <div class="tr-rating-types">
                          <div class="tr-rating-type">  
                            ...
                            <div class="tr-reviews-nums rcmd-count"><?php echo e($recommendedCount); ?></div>
                          </div>
                          <div class="tr-rating-type">
                            ...
                            <div class="tr-reviews-nums notrcmd-count"><?php echo e($notRecommendedCount); ?></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="review-data">    
                          ...
                          <div class="tr-customer-reviews ">
                            <?php $__currentLoopData = $sightreviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="tr-customer-review">
                                <div class="tr-customer-details">
                                  <div class="tr-customer-detail">
                                    <?php if(!empty($review->profile_image) && file_exists(public_path($review->profile_image))): ?>
                                        <img loading="lazy" src="<?php echo e(asset($review->profile_image)); ?>" alt="<?php echo e($review->FirstName); ?>" class="user-profile-image">
                                    <?php else: ?>
                                        <img loading="lazy" src="<?php echo e(asset('frontend/hotel-detail/images/usericon-review.png')); ?>" alt="<?php echo e($review->FirstName); ?>" class="user-profile-image">
                                    <?php endif; ?>
                                    <div class="tr-customer-name">
                                      <div><?php echo e($review->FirstName); ?></div>
                                      <div class="tr-recommended-title <?php if($review->IsRecommend == 1): ?> tr-heart-green <?php elseif($review->IsRecommend == 0): ?> tr-heart-red <?php endif; ?>"> Recommended
                                        <!-- <span class="tr-time">(1 week ago)</span> -->
                                      </div>
                                    </div>
                                    <?php if(!empty($searchresult[0]->Name)): ?>
                                        <div class="tr-hotel-place"><?php echo e($searchresult[0]->Name); ?></div>
                                    <?php elseif(!empty($searchresult[0]->LocationName)): ?>
                                        <div class="tr-hotel-place"><?php echo e($searchresult[0]->LocationName); ?></div>
                                    <?php else: ?>
                                        <div class="tr-hotel-place">Location not specified</div>
                                    <?php endif; ?>
                                  </div>
                                  <div class="tr-report">
                                ...
                                <p><?php echo e($review->ReviewDescription); ?></p>
                                <div class="tr-helpful">
                                  Was this helpful? 
                                  <button class="tr-like-button">Like</button>
                                  <button class="tr-dislike-button">Dislike</button>
                   ...
                   <?php else: ?>
                      <div class="col-lg-7" id="review-not-foundimg">
                        <img src="<?php echo e(asset('/frontend/hotel-detail/images/no-review-found.png')); ?>" alt="No Reviews Found" style="height: 350px;">
            ...
            <!--REVIEWS SECTION - END-->
             ...
             <!--FAQS - START-->
         <div class="tr-faqs-section mb-5">
                    <h3 class="d-none d-md-block mb-4">FAQ's about the <?php echo e($searchresult[0]->Title); ?></h3>
                    <h3 class="d-block d-sm-block d-md-none mb-3">FAQ's</h3>
                    <span id="detailfaqdata">
                        <!-- Timing Information Section -->
                        <?php if(!empty($timings)): ?>
                        <!-- <div class="tr-faqs-ques-ans"> -->
                            <div class="tr-qa-item mb-4 p-3">
                               
                                <div class="tr-answer">
                                    <h3 class="mt-2 mb-3">Timings</h3>
                                    <div class="timing-details">
                                        <div class="table-responsive">
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <?php if(count($timings) > 0): ?>
                                                        <?php $__currentLoopData = $timings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $hours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td class="fw-bold py-1"><?php echo e(ucfirst($day)); ?></td>
                                                                <td class=" <?php echo e($day == strtolower(now()->format('l'))); ?> py-1 pe-3">
                                                                    <?php if(isset($hours['open']) && $hours['open']): ?>
                        ...
                        <?php if(isset($faq) && !empty((array) $faq)): ?>
                            <div class="tr-faqs-ques-ans">
                                <?php $__currentLoopData = $faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faqItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tr-qa-item mb-4 p-3">
                                        <div class="tr-question fw-bold mb-2"><?php echo e($faqItem->Faquestion); ?></div>
                                        <div class="tr-answer"><?php echo $faqItem->Answer; ?></div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php else: ?>
                    ...
                    <button class="tr-ask-a-ques d-block d-sm-block d-md-none mt-3 btn btn-outline-primary">Ask a
                        question</button>
                    <div class="tr-popup">
                        <div class="tr-popup-content">
                            ...
                            <form>
                                ...
                                <textarea class="form-control mb-3" placeholder="Type your question here" rows="4"></textarea>
                                <button class="tr-popup-btn btn btn-primary">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
                   ...
                   <li><a href="https://www.travell.co.in">Travell</a></li>
                    ...
                    <?php if(!empty($breadcumb)): ?>
                        <?php if($breadcumb[0]->ccName != ""): ?>
                            <li>
                                <a href="<?php echo e(route('explore_continent_list',[$breadcumb[0]->contid,$breadcumb[0]->ccName])); ?>" target="_blank">
                                    <?php echo e($breadcumb[0]->ccName); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <li>
                            <a href="<?php echo e(route('explore_country_list',[$breadcumb[0]->CountryId,$breadcumb[0]->cslug])); ?>" target="_blank">
                                <?php if(!empty($breadcumb)): ?> <?php echo e($breadcumb[0]->CountryName); ?> <?php endif; ?>
                            </a>
                        </li>
                    <?php endif; ?>
    ...
    <?php $__currentLoopData = $locationPatent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
            <a href="<?php echo e(route('search.results',[$location['LocationId'].'-'.strtolower($location['slug'])])); ?>" target="_blank">
                <?php echo e($location['Name']); ?>
...
<?php endif; ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('search.results',[$searchresult[0]->slugid.'-'.strtolower($searchresult[0]->Lslug)])); ?>" target="_blank">
                            <span><?php echo e($searchresult[0]->Name); ?></span>
                        </a>
                    </li>
                    <li class="active">
                        <span><?php echo e($searchresult[0]->Title); ?></span>
                    </li>
                </ul>
            <?php endif; ?>
 ...
 <div class="modal" id="shareModal">
    ...
    <!-- Hotel Image -->
    <div class="tr-hotel-img">
        <?php if(!empty($searchresult[0]->hotelid) && isset($images[$searchresult[0]->hotelid][0])): ?>
            <img src="https://photo.hotellook.com/image_v2/limit/<?php echo e($images[$searchresult[0]->hotelid][0]); ?>/628/567.auto" alt="<?php echo e($searchresult[0]->Title); ?>">
        <?php elseif(isset($Sight_image[0]->Image) && $Sight_image[0]->Image != ''): ?>
            <img src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($Sight_image[0]->Image); ?>" alt="<?php echo e($searchresult[0]->Title); ?>" height="445" width="608">
        <?php else: ?>
            <img src="<?php echo e(asset('/frontend/hotel-detail/images/no-data-place-image.png')); ?>" alt="No Image Available">
        <?php endif; ?>
    </div>
    ...
    <div class="tr-share-details">
        ...
        <span class="tr-hotel-name">
            <?php echo e($searchresult[0]->Title ?? $searchresult[0]->Title ?? 'Hotel Name Not Available'); ?>

        </span>

     <!-- Hotel Address -->
        <div class="tr-hotel-address">
            <?php echo e($searchresult[0]->Address ?? 'Address Not Available'); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="tr-days-time-section">
                <?php if(isset($timings) && !empty($timings)): ?>
                    <?php
                    ...
                    <?php if(isset($timings[$currentDay])): ?>
                        <?php
                        ...
                        <div class="tr-day-time">
                            ...
                            <?php if($currentTimestamp >= $startTimestamp && $currentTimestamp < $endTimestamp): ?>
                                <div class="tr-timing">
                                    ...
                                    <?php echo e(date('h:i A', $startTimestamp)); ?> - <?php echo e(date('h:i A', $endTimestamp)); ?> (OPEN NOW)
                                </div>
                            <?php else: ?>
                                <div class="tr-timing">
                                    <?php echo e(date('h:i A', $startTimestamp)); ?> - <?php echo e(date('h:i A', $endTimestamp)); ?> (CLOSED NOW)
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tr-day-time">
                            <div class="tr-days"><?php echo e(ucfirst($day)); ?></div>
                            <?php if(isset($timings[$day])): ?>
                                <?php
                                $startTime = $timings[$day]['open'];
                                $endTime = $timings[$day]['close'];
                                ?>
                                <div class="tr-timing">
                                    <?php echo e(date('h:i A', strtotime($startTime))); ?> - <?php echo e(date('h:i A', strtotime($endTime))); ?>
        ...
        <div class="tr-write-review-content">
            <div class="tr-hotel-reviews-details">
                <div class="tr-main-image">
                    <img src="<?php if( isset($Sight_image[0]->Image) && $Sight_image[0]->Image !=''): ?>  https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($Sight_image[0]->Image); ?>  <?php else: ?> <?php echo e(asset('/frontend/hotel-detail/images/no-data-place-image.png')); ?> <?php endif; ?> " alt="Tower Bridge" class="d-block w-100" height="200" width="482">                    
                   </div>
                <div class="tr-hotel-info">
                    <h4 class="tr-hotel-name"><?php echo e($searchresult[0]->Title); ?></h4>
                    <div class="tr-hotel-address"><?php echo e($searchresult[0]->Address); ?></div> 
                </div>
            </div>

            <form id="highlight-review" class="add_highlight_review">
            <input type="hidden" name="sight_id" value="<?php echo e($searchresult[0]->SightId); ?>">
      ...
      <div class="tr-gallery-categories">
        <div class="tr-galleries-section">
          <div class="tr-gallery-category">
            <ul>
             <?php if(!$Sight_image->isEmpty()): ?>
            <?php $__currentLoopData = $Sight_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li data-bs-toggle="modal" data-bs-target="#gallerySliderModal">
                <img loading="lazy" src="<?php if(isset($image->Image) && $image->Image != ''): ?> 
                https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/<?php echo e($image->Image); ?>                                                                              
                                          <?php endif; ?>" alt="Outdoor Pictures 1" height="300" height="270">
              </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            </ul>
      ...
      <div class="tr-popup-content">
        ...
        <div class="tr-write-review-content add_review">
          ...
          <form id="s-review" class="add_review">
              <?php if(session('frontend_user') && isset(session('frontend_user')['UserId'])): ?>
                <input type="hidden" name="user_id" value="<?php echo e(session('frontend_user')['UserId']); ?>">
              <?php endif; ?>
            <div class="tr-overall-rating">
              <div class="tr-rating">
              <label>Do you recommend visiting <?php echo e($searchresult[0]->Title); ?>?</label>
              <div class="tr-recommended-actions">
                <label>
          ...
          <?php if(!$gettiming->isEmpty()): ?>
              ...
              <?php if(isset($timings[$currentDay])): ?>
                  ...
                  <div class="tr-day-time">
                      ...
                      <?php if($todayStartTime == "00:00" && $todayEndTime == "23:59"): ?>
                      <div class="tr-timing"><span class="tr-open-circle"></span>Open 24 hours</div>
                      <?php elseif($todayStartTime == "00:00" && $todayEndTime == "00:00" || $todayStartTime == "closed" && $todayEndTime == "closed"): ?>
                      <div class="tr-timing tr-closed">Closed Today</div>
                      <?php elseif($todayStartTime != "closed" && $todayEndTime != "closed"): ?>
                          <?php if($currentTime >= $todayStartTime && $currentTime <= $todayEndTime): ?>
                          <div class="tr-timing"><span class="tr-open-circle"></span><?php echo e(date('h:i A', strtotime($todayStartTime))); ?> - <?php echo e(date('h:i A', strtotime($todayEndTime))); ?> (OPEN NOW)</div>
                          <?php else: ?>
                          <div class="tr-timing"><?php echo e(date('h:i A', strtotime($todayStartTime))); ?> - <?php echo e(date('h:i A', strtotime($todayEndTime))); ?> (CLOSED NOW)</div>
                          <?php endif; ?>
                      <?php else: ?>
                      <div class="tr-timing tr-closed">Closed Today</div>
                      <?php endif; ?>
                  </div>
              <?php elseif(isset($data['time'][$currentDay])): ?>
                  <?php
              ...
              <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="tr-day-time">
                      ...
                      <?php if(isset($timings[$day])): ?>
                          ...
                          <?php if($startTime == "00:00" && $endTime == "23:59"): ?>
                          <div class="tr-timing">Open 24 hours</div>
                          <?php elseif($startTime == "00:00" && $endTime == "00:00" || $startTime == "closed" && $endTime == "closed"): ?>
                          <div class="tr-timing tr-closed">Closed</div>
                          <?php elseif($startTime != "closed" && $endTime != "closed"): ?>
                          <div class="tr-timing"><?php echo e(date('h:i A', strtotime($startTime))); ?> - <?php echo e(date('h:i A', strtotime($endTime))); ?></div>
                          <?php else: ?>
                          <div class="tr-timing tr-closed">Closed</div>
                          <?php endif; ?>
                      <?php elseif(isset($data['time'][$day])): ?>
                          <?php
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="tr-place-details">
            <div class="tr-image">
              <img loading="lazy" src="<?php if( isset($Sight_image[0]->Image) && $Sight_image[0]->Image !=''): ?> <?php echo e(asset('https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/'. $Sight_image[0]->Image)); ?> <?php else: ?> <?php echo e(asset('/images/Hotel lobby.svg')); ?> <?php endif; ?> " alt="<?php echo e($searchresult[0]->Title); ?>">
            </div>
            <div class="tr-details">
              <div class="tr-name-and-address">
                <h4 class="tr-name"><?php echo e($searchresult[0]->Title); ?></h4>
                <?php if($searchresult[0]->IsMustSee == 1): ?>
                  <span class="d-none d-sm-block d-md-block">Must see</span>
                  <?php endif; ?>
                <div class="tr-address"><?php echo e($searchresult[0]->Address); ?></div>
              </div>
              <div class="tr-like-review">
                <div class="tr-heart">
                ...
                <div class="tr-ranting-percent"><?php echo e($result); ?>% <?php else: ?> -- <?php endif; ?></div>
                <div class="tr-excellent" style="color:<?php echo e($color); ?>"><?php echo e($ratingtext); ?></div>
              </div>
            </div>
          </div>
...
<?php 
  ...
  <script src="<?php echo e(asset('/js/jquery3.6.js')); ?>"></script>


  <script src="<?php echo e(asset('/css/hotel-css/t-datepicker.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/js/datepicker-homepage.js')); ?>"></script>
...
<script src="<?php echo e(asset('/js/map_leaflet.js')); ?>"></script>
...
<script src="https://unpkg.com/leaflet/dist/leaflet.js"></script>
  <script>
  var mapOptions = {
    center: [<?php echo e($latitude); ?>, <?php echo e($longitude); ?>], // Use Blade echo to insert variables
    zoom: 10
  };
  ...
  var customIcon = L.icon({
    iconUrl: '<?php echo e(asset("/js/images/Hotel.svg")); ?>',
    iconSize: [62, 62], // Adjust the size as needed
    iconAnchor: [16, 32], // Adjust the anchor point if needed
  });

  var marker = L.marker([<?php echo e($latitude); ?>, <?php echo e($longitude); ?>], { // Correct Blade syntax
    icon: customIcon
  }).addTo(map);
...
$(document).ready(function() {
    ...
    $('#saveAbout').click(function(e) {
        ...
        var sightId = <?php echo e($searchresult[0]->SightId); ?>;
...
$("#highlight-review").submit(function(e) {
  ...
  formData.append('sight_id', <?php echo e($searchresult[0]->SightId); ?>);
...
</script><?php /**PATH C:\wamp64\www\tavelll\resources\views/sightdetails.blade.php ENDPATH**/ ?>