...
<head>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (lcpImage) {
                // Use requestIdleCallback to optimize rendering
    ...
    <title id="page-title">
        {{ e($searchresult[0]->name) }} in {{ e($searchresult[0]->CityName) . ', ' }} @if (!empty($locationPatent))
            {{ e(last($locationPatent)['Name']) }}
        @elseif(!$getcontlink->isEmpty())
            {{ e($getcontlink[0]->Name) }}
            @endif - Best Prices @if ($minprice > 0)
    ...
    @php
        ...
        if (
            isset($searchresult, $searchresult[0]) &&
            is_object($searchresult[0]) &&
            property_exists($searchresult[0], 'hotelid')
        ) {
        ...
        $firstImageId = null;
        if (
            $currentHotelIdForImage &&
            isset($images[$currentHotelIdForImage]) &&
            is_array($images[$currentHotelIdForImage]) &&
            count($images[$currentHotelIdForImage]) > 0
        ) {
    ...
    @if ($firstImageId)
        <link rel="preload" as="image"
            href="https://photo.hotellook.com/image_v2/limit/{{ $firstImageId }}/412/344.webp" fetchpriority="high">
    @endif
                    ...
                    <div class="tr-hotel-info">
                        ...
                        <div class="tr-raiting">
                            @if ($searchresult[0]->rating != '' && $searchresult[0]->rating != 0)
                                ...
                                ?>
                                <a href="javascript:void(0);" class="tr-excellent"
                                ...
                                <div class="tr-main-image">
                                    @if (isset($images[$searchresult[0]->hotelid][0]) && $images[$searchresult[0]->hotelid][0] != '')
                                        <img src="https://photo.hotellook.com/image_v2/limit/{{ $images[$searchresult[0]->hotelid][0] }}/628/567.auto"
                                            alt="Room Image" style="height: 440px;width: 440px;" loading="lazy">
                                    @else
                                    ...
                                    @if (!empty($searchresult[0]->hotelid))
                                        <div class="carousel-item active">
                                            @if (isset($images[$searchresult[0]->hotelid][0]) && $images[$searchresult[0]->hotelid][0] != '')
                                                <picture>
                                                    <source
                                                        srcset="https://photo.hotellook.com/image_v2/limit/{{ $images[$searchresult[0]->hotelid][0] }}/412/344.webp"
                                                        type="image/webp">
                                                    <source
                                                        srcset="https://photo.hotellook.com/image_v2/limit/{{ $images[$searchresult[0]->hotelid][0] }}/412/344.jpg"
                                                        type="image/jpeg">
                                                    <img src="https://photo.hotellook.com/image_v2/limit/{{ $images[$searchresult[0]->hotelid][0] }}/412/344.jpg"
                                                        alt="Room Image" height="344" width="412"
                                                        fetchpriority="high" decoding="async"
                                                        onload="this.classList.add('loaded')" class="lcp-image">
                                                </picture>
                                            @else
                                                <img src="{{ asset('/images/Hotel lobby-image.png') }}"
                                ...
                                <ul id="thingsToKnowContent"
                                    ...
                                    @elseif (is_string($searchresult[0]->ThingstoKnow))
                                        ...
                                        @foreach ($thingsArray as $thing)
                                            @if (!empty(trim($thing)))
                                                <li><img src="{{ asset('/frontend/hotel-detail/images/amenities/circle.svg') }}"
                                                        alt="icon" class="Icon"> {{ trim($thing) }}.</li>
                                            @endif
                                        @endforeach
                                    @endif
                                    ...
                                    @if (isset($searchresult[0]->Smoking_Policy))
                                        <li><img src="{{ asset('/frontend/hotel-detail/images/amenities/circle.svg') }}"
                                                alt="icon" class="Icon"> <strong>Smoking Policy:</strong>
...
@endif
                    ...
                    <div class="tr-col">
                        ...
                        <input type="text" id="checkInInput2" class="dateInput checkinval2" @if (Session::has('checkin')) value="{{ $checkin }}" @endif placeholder="Select a date" name="" readonly autocomplete="off">
                    </div>
                    <div class="tr-col">
                        <label for="checkOutDate">Check-out</label>

                        <input type="text" id="checkOutDate" class="dateInput checkoutval2" @if (Session::has('checkin')) value="{{ $checkout }}" @endif placeholder="Select a date" name="" readonly autocomplete="off">
                    </div>
                </div>
                </div>
                    ...
                    @else
                        <div class="col-lg-7" id="review-not-foundimg">
                            <img src="{{ asset('/frontend/hotel-detail/images/no-review-found.png') }}"
                                alt="Left Arrow" height="height: 200;">Review not found
                        </div>
                    @endif
                </div>
                ...
                <div class="tr-hotel-reviews-details">
                    <div class="tr-main-image">
                        <img src="{{ asset('/frontend/hotel-detail/images/no-data-place-image.png') }}"
                            alt="img" class="d-block w-100" height="200" width="482">
                    </div>
                    <div class="tr-hotel-info">
