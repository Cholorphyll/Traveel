 ...
 <script type="application/ld+json">
{
  ...
  "@graph": [
    {
    "@type": "WebPage",
    "@id": "https://www.travell.co.in/privacy_policy",
    "name": "Privacy Policy for Travell",
    "url": "https://www.travell.co.in/privacy_policy",
    "inLanguage": "en",
    "isPartOf": {
...
<body>
    ...
    .tr-logged:hover + .tr-myaccount-modal,
    .tr-myaccount-modal:hover {
        display: block;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const loggedButton = document.querySelector('.tr-logged');
        const accountModal = document.querySelector('.tr-myaccount-modal');
        
        if (loggedButton && accountModal) {
            loggedButton.addEventListener('click', function(e) {
                e.stopPropagation();
                const isHidden = accountModal.style.display === 'none' || !accountModal.style.display;
                accountModal.style.display = isHidden ? 'block' : 'none';
            });
            
            // Close dropdown when clicking outside
            document.addEventListener('click', function(e) {
                if (!accountModal.contains(e.target) && e.target !== loggedButton) {
        ...
        const dropdownLinks = document.querySelectorAll('.tr-myaccount-modal a');
