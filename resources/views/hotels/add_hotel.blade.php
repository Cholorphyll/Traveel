<x-app-layout>
              ...
              <div class="row justify-content-center">
                <div class="col-md-12">
                  <div class="white_shd full margin_bottom_30">
                    ...
                    <form class="" action="{{ route('storeHotel',['id' => $hotel->id]) }}" method="POST">
                      @csrf
                      <div class="row">
                        <div class="col-md-12">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group mt-3">
                                ...
                                <textarea type="text" name='Highlights' value="" class="form-control rounded-3"
                                  placeholder=""></textarea>
                              </div>
                            </div>
  ...
  <div class="form-group mt-3">
    ...
    <select class="form-select" aria-label="Default select example" name="propertyType">
      ...
      <option value="4">Apartment / Condominium</option>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group mt-3">
                              ...
                              <input type="text" name='location_score' value=""
