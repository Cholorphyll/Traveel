...
?>
  ...
  @if(!empty($roomsdsc))
  <?php  $countRoomdescKeys = count(array_keys((array)$roomsdsc));
                $countRoomdescKeys -= 2;
                $countRoomdescKeys1 = count(array_keys((array)$roomsdsc));
              ?>    
  @foreach ($roomsdsc as $keys=>$value)
                <div class="tr-hotel-deatils">
                  ...
                  <div class="tr-hotel-deatil">
                   <h2 style="text-align: left; margin-left: 0;">{{ $keys }}</h2>
                    <div class="tr-hotel-location"></div>
                    <ul class="tr-desktop">
                  ...
                  <div class="tr-hotel-price-lists">
                    <ul>
                      ...
                      @if(!empty($roomsprice))
                          @foreach($roomsprice as $keysp => $val)
                          @if($keys == $keysp)
                              <li>
                                  <img src="{{ 'https://pics.avs.io/hl_gates/100/40/' . $val['agencyId'] . '.png' }}"
                                  alt="Agency Logo" loading="lazy" style="height: 24px;" >                         
                                  <a href="{{$val['fullBookingURL']}}"><strong>${{$val['price']}}</strong> /night</a>
                              </li>
                            @endif
                          @endforeach
                      @endif
