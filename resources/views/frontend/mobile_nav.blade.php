   <div class="tr-mobile-nav-section">
      <div class="tr-mobile-nav-content">
        ...
        <div class="tr-nav-header">
          <div class="tr-logo">
            <img src="{{ asset('frontend/hotel-detail/images/where2.png') }}" alt="where2 small logo" style="width: 150px !important; height: auto !important;">
          </div>
        ...
        <div class="tr-actions">
            <button class="tr-btn tr-write-review"><a href="{{route('userlogout')}}">Logout</a></button>
          </div>
