          ...
          <div class="tr-footer-top">
            <div class="tr-footer-logo">
              <a href="https://www.travell.co/">
				<picture>
                <source srcset="{{asset('/frontend/hotel-detail/images/travell-white-logo.webp')}}" type="image/webp">
                <img src="{{asset('/frontend/hotel-detail/images/travell-white-logo.webp')}}" alt="travell-white-logo" loading="lazy" class="lcp-image">
               </picture>
			 </a>
