    ...
    <script type="application/ld+json">
{
  ...
  {
    "@type": "WebPage",
    "@id": "https://www.travell.co.in/terms",
    "name": "Terms and Conditions | Travell",
    "url": "https://www.travell.co.in/terms",
    "inLanguage": "en",
    "isPartOf": {
  ...
  },
  {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://www.travell.co.in/logo.png",
      "width": 200,
      "height": 60
    },
    "sameAs": [
    ...
    @include('frontend.header')
            ...
            <div class="col-sm-12">
              ...
              <div class="tr-single-page">
                <div class="tr-terms-and-conditions-section">
                  ...
                  <p>Welcome to Travell! These Terms and Conditions govern your use of our website, located at www.travell.co.in (referred to as "the Site"), and our services. By accessing or using our website, you agree to comply with and be bound by the following terms. Please read them carefully.</p>
                  ...
                  <address>
                    ...
                    Email: <a href="mailto:Travell.co@outlook.in">Travell.co@outlook.in</a>
                  </address>
                </div>
              </div>
        ...
        <div class="tr-breadcrumb-section">
          <ul class="tr-breadcrumb">
            <li><a href="{{route('homepage')}}">Travell</a></li>             
            <li>Terms</li>
          </ul>
        </div>
        <!--BREADCRUMB - END-->
