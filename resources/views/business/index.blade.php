...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/css/business_index.css')}}">
  <!-- end nav css -->
  <style>
  .recent-his {
    margin-top: 53px;
        ...
        <div class="row">
          <div class="col-md-4"><input type="text" class="form-control" placeholder="Location" id="Location">
            ...
            <div class="recent-his search-box-info  d-none bg-white px-4 b-20 shadow-1 position-absolute">
              ...
              <p id="getresult" class="px-4 autoCompletewrapper" style="margin-top: 31px;width: auto;"></p>
            </div>
          </div>
          ...
          <div class="business search-box-info  d-none bg-white px-4 b-20 shadow-1 position-absolute">
            <p id="business_result" class="px-4 autoCompletewrapper" style="margin-left: 310px;
    margin-top: 31px;width: auto;"></p>
          </div>
      ...
      <section class=" other-sections my-md-64px">
        ...
        <div class=" howwework">
          <div class="text-center card flex-1">
            ...
            <img src="{{asset('images/globe.svg')}}" alt="" class="mb-20 d-flex justify-content-center mx-auto">
          ...
          <div class="text-center card flex-1 centercard">
            ...
            <img src="{{asset('images/searchglobe.svg')}}" alt=""
          ...
          <div class="text-center card flex-1">
            ...
            <img src="{{asset('images/Planning.svg')}}" alt=""
              class="mb-20 d-flex justify-content-center mx-auto">
          ...
          <form action="{{ url('/save_user') }}" method="post" id="myForm">
            ...
            <div class="modal-body">
              ...
              <div class="col-md-12">
                ...
                <div class="alert alert-danger danger d-none">
                      <p class="error-msg"></p>
                </div>
                <div class="row">
            ...
            <div class="modal-footer">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <!-- <div class="col-md-6">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="height: 38px;">Close</button>
                  </div> -->
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-md-6">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                              ...
                              <p class="mt-3" style="text-align: center;">Not a member? <a class="" data-bs-toggle="modal" data-bs-target="#exampleModal"> Register</a></p>
                </div>
        ...
        $.ajax({
          ...
          success: function(response) {
           if (response == 0 ) {
            ...
            if (response == 'u0') {
              $('#username-msg').text('Username already exists. Please choose a different username.').css(
                'color', 'red');
              unique = false;
            }
            ...
            if (response == 21 ) {
              ...
              $('.success-msg').text('Registration successful. Please check your email for verification.');
              unique = false;
            }
            if (response == 22) {
    ...
    $(document).ready(function() {
      $(document).on('click', '#loginform', function(event) {
        ...
        var pass = $('.password').val();
 		if (email == '' || pass == '') {
          $('#password-msg1').text('Email and Password required').css('color','red');
          return false; // Skip validation if email is empty
        }else{
          $('#password-msg1').text('');
        }
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response == 2) {
              //alert(response)
              window.location.href = base_url + 'business_dashboard';
            }
          },
