      ...
      <div class="col-md-12 mb-3">
        <form action="" method="post" enctype="multipart/form-data" id="add-uploadimg">
          <div class="row mb-3">
            ...
            <img src="{{asset('business/images-icon.svg')}}" alt="" height="35"><input type="file"> +Add More Photos
      ...
      <div>
        <div class="row mb-3">
          ...
          <!-- <div class="mt-3 col-md-6">
            <div class="box-border"><img src="{{asset('business/images-icon.svg')}}" alt="" height="35"> Respond to Reviews
         ...
         <img src="https://s3-us-west-2.amazonaws.com/s3-travell/business-images/{{$val->Image}}"
                alt="" class="image" style="width: 323px;height: 231px;">
                <span class="delete-sight_image" data-id="{{ $val->id }}" data-sightid="{{ $val->Sightid }}" style="position: absolute; cursor: pointer;">
