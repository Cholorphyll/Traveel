        ...
        <div class="row">
          <div class="col-md-6">
            <div class="info-box general-information">
              ...
              <a href="{{route('edit_sight_info',[$getbusiness[0]->bid])}}" class="btn btn-outline-dark">cancel</a>
