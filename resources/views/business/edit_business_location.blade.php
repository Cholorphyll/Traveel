...
<body>
  ...
  <div class="">
    <div class="container">
      <h5 class="mt-5"><a href="{{route('view_hotel_business',[$getbusiness[0]->bid,$getbusiness[0]->bslug])}}">back</a></h5>
      <!-- start business -->
      <div class="col-md-12 updatedata">
        
        <hr>
        <form action="{{route('update_map_data')}}" method="post" id="">
          @csrf
        <h5>Location</h5>
        <div class="row">
          <div class="col-md-6 ">
            <div class="info-box general-information">
              ...
              <a href="{{route('view_hotel_business',[$getbusiness[0]->bid,$getbusiness[0]->bslug])}}" class="btn btn-outline-dark">cancel</a>
