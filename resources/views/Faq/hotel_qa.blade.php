        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <h2 class="mb-4">Hotel Questions & Answers</h2>
                        ...
                        @else
                            <div class="alert alert-info">
                                No questions found for this hotel. Add a new question to get started.
                            </div>
                        @endif
                    </div>
                </div>
...
<div class="modal fade" id="deleteQuestionModal" tabindex="-1" role="dialog" aria-labelledby="deleteQuestionModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('delete_hotel_qa') }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">
