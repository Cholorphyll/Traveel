          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Edit Attraction Image</h2>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-12">
                  <div class="white_shd full margin_bottom_30">
                    ...
                    <div class="row d-flex justify-content-end">
                      ...
                      <div class="col-md-3 form-group">
                        <div class="form-search form-search-icon-right">
                          <input type="text" name="search_value" id="filter-sightimgbyid" class="form-control rounded-3"
                    ...
                    <input type="hidden"  id="sighid" value=" @if(!$getsight->isEmpty()){{ $getsight[0]->SightId}} @endif">
                          ...
                          <div class="form-group mt-3">
                            ...
                            <div class="historical-place mb-3">
                              ...
                              <div class="image-container"
                                ...
                                <img src="{{ asset('/sight-images/' . $value->Image) }}" alt="Image"
                          ...
                          <div class="modal-body">
                            ...
                            <div class="container">
                              ...
                              <div class="col-md-12 form-group">
                                ...
                                @endif
                                <form action="{{ route('upload_sight_Image',[$getsight[0]->SightId]) }}" method="post"
                                  ...
                                  <span class="mt-3  custom-faq-buttons">
                                    <button id="" type="submit" data-id="{{ $getsight[0]->SightId}}"
