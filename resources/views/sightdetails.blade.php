...
@if(!empty($searchresult)) @php $title = $searchresult[0]->MetaTagTitle; $MetaTagDescription = $searchresult[0]->MetaTagDescription; $lname=$searchresult[0]->Name; @endphp @endif
 <title>
   ...
   @if(session('frontend_user') && isset(session('frontend_user')['UserId']))
    <meta name="user-id" content="{{ session('frontend_user')['UserId'] }}">
    @else
...
@endif
            ...
            @if(!empty($searchresult[0]->best_for) || !empty($searchresult[0]->best_season) || !empty($searchresult[0]->best_time_to_visit))
            <div class="best__Component">
              @if(!empty($searchresult[0]->best_for))
              <div class="best__ComponentSection">
                ...
                <div class="best__ComponentDetails">
                  <h4>Best for</h4>
                  <p>{{$searchresult[0]->best_for}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->best_season))
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Bestseason.svg" alt=""></div>
                <div class="best__ComponentDetails">
                  <h4>Best season</h4>
                  <p>{{$searchresult[0]->best_season}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->best_time_to_visit))
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Besttime.svg" alt=""></div>
                <div class="best__ComponentDetails">
                  <h4>Best time to visit</h4>
                  <p>{{$searchresult[0]->best_time_to_visit}}</p>
                </div>
              </div>
              @endif
            </div>
...
@endif</p-->
            ...
            <!-- Accessibility -->
            @if(!empty($searchresult[0]->accessibility) || !empty($searchresult[0]->kid_friendly) || !empty($searchresult[0]->pet_friendly) || !empty($searchresult[0]->food_facilities) || !empty($searchresult[0]->public_restrooms) || !empty($searchresult[0]->parking_facilities))
            <div class="best__Component">
              @if(!empty($searchresult[0]->accessibility))
              <div class="best__ComponentSection">
                <div class="icon__Section mt1"><img src="images/Accessibility.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Accessibility</h4>
                  <p>{{$searchresult[0]->accessibility}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->kid_friendly))
              <div class="best__ComponentSection">
                <div class="icon__Section mt1"><img src="images/Kidfriendly.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Kid friendly</h4>
                  <p>{{$searchresult[0]->kid_friendly}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->pet_friendly))
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Petfriendly.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Pet friendly</h4>
                  <p>{{$searchresult[0]->pet_friendly}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->food_facilities))
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/foodfacilities.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Food facilities/restaurants/cafes</h4>
                  <p>{{$searchresult[0]->food_facilities}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->public_restrooms))
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Publicrestrooms.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Public restrooms</h4>
                  <p>{{$searchresult[0]->public_restrooms}}</p>
                </div>
              </div>
              @endif
              @if(!empty($searchresult[0]->parking_facilities))
              <div class="best__ComponentSection">
                <div class="icon__Section"><img src="images/Parking.svg" alt=""></div>
                <div class="Accessibility__Compoent">
                  <h4>Parking facilities</h4>
                  <p>{{$searchresult[0]->parking_facilities}}</p>
                </div>
              </div>
              @endif
            </div>
        ...
        <div class="row">
          ...
          <!--EXPLORE OTHER OPTIONS IN AND AROUND SECTION - START-->
                            ...
                            <div class="tr-tourist-place">
                              <div class="tr-img">
                                <a href="javascript:void(0);">
                                  <img loading="lazy" src="{{ asset('/frontend/hotel-detail/images/tourist-places-1.png') }}" alt="tourist-places" class="lcp-image">
                                </a>
                              </div>
                              <div class="tr-details">
                                <div class="tr-place-name">
                                ...
                                <div class="tr-place-type jjjjjj">{{ $nearbyatt->ctitle }}</div>
                                <div class="tr-like-review">
            ...
            @if(!empty($searchresult[0]->packing_checklist) || !empty($searchresult[0]->what_people_like) || !empty($searchresult[0]->what_people_dont_like) || !empty($searchresult[0]->what_to_do) || !empty($searchresult[0]->what_not_to_do))
            <section class="py-5 checkSection">
              <div class="row">
                @if(!empty($searchresult[0]->packing_checklist))
                <div class="col-md-4">
                  <div class="checklist__box">
                    <h4>Packing checklist</h4>
                    {!! $searchresult[0]->packing_checklist !!}
                  </div>
                </div>
                @endif

                @if(!empty($searchresult[0]->what_people_like) || !empty($searchresult[0]->what_people_dont_like))
                <div class="col-md-4 @if(!empty($searchresult[0]->packing_checklist)) LeftSideBorder @endif">
                  @if(!empty($searchresult[0]->what_people_like))
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/likeicon.svg" alt=""></div>
                    <div>
                      <h5>What people like</h5>
                      {!! $searchresult[0]->what_people_like !!}
                    </div>
                  </div>
                  @endif
                  @if(!empty($searchresult[0]->what_people_dont_like))
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/dislike.svg" alt=""></div>
                    <div>
                      <h5>What don't people like</h5>
                      {!! $searchresult[0]->what_people_dont_like !!}
                    </div>
                  </div>
                  @endif
                </div>
                ...
                @if(!empty($searchresult[0]->what_to_do) || !empty($searchresult[0]->what_not_to_do))
                <div class="col-md-4 LeftSideBorder">
                  @if(!empty($searchresult[0]->what_to_do))
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/do.svg" alt=""></div>
                    <div>
                      <h5>DO</h5>
                      {!! $searchresult[0]->what_to_do !!}
                    </div>
                  </div>
                  @endif
                  @if(!empty($searchresult[0]->what_not_to_do))
                  <div class="checklist">
                    <div class="checkdetails"><img src="images/dont.svg" alt=""></div>
                    <div>
                      <h5>DON'T</h5>
                      {!! $searchresult[0]->what_not_to_do !!}
                    </div>
                  </div>
                  @endif
                </div>
                      ...
                      @foreach($nearby_hotel as $nearby_hotels)
                          <div class="tr-nearby-hotel-list">
                              <div class="tr-hotel-img">
                                  <a href="javascript:void(0);">
                                      <img loading="lazy" src="https://photo.hotellook.com/image_v2/limit/h{{$nearby_hotels->hotel_id}}_1/290/291.jpg" alt="NearBy Hotel" height="290" width="291" onerror="this.onerror=null;this.src='https://www.travell.co.in/frontend/hotel-detail/images/Hotel%20lobby-image.png';">
                                  </a>
                              ...
                              <div class="tr-customer-review">
                                <div class="tr-customer-details">
                                  <div class="tr-customer-detail">
                                    @if(!empty($review->profile_image) && file_exists(public_path($review->profile_image)))
                                        <img loading="lazy" src="{{ asset($review->profile_image) }}" alt="{{ $review->FirstName }}" class="user-profile-image">
                                    @else
                                        <img loading="lazy" src="{{ asset('frontend/hotel-detail/images/usericon-review.png') }}" alt="{{ $review->FirstName }}" class="user-profile-image">
                                    @endif
                                    ...
                                    @if(!empty($searchresult[0]->Name))
                                        <div class="tr-hotel-place">{{ $searchresult[0]->Name }}</div>
                                    @elseif(!empty($searchresult[0]->LocationName))
                                        <div class="tr-hotel-place">{{ $searchresult[0]->LocationName }}</div>
                                    @else
      ...
      <div class="tr-popup-content">
        ...
        <div class="tr-write-review-content add_review">
          ...
          <form id="s-review" class="add_review">
              @if(session('frontend_user') && isset(session('frontend_user')['UserId']))
                <input type="hidden" name="user_id" value="{{ session('frontend_user')['UserId'] }}">
              @endif
