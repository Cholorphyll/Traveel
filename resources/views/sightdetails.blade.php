...
<head>
    ...
    @if (!empty($searchresult))
        @php
            $title = $searchresult[0]->MetaTagTitle;
            $MetaTagDescription = $searchresult[0]->MetaTagDescription;
            $lname = $searchresult[0]->Name;
        @endphp
    @endif
    <title>
        @if (!empty($title))
        ...
        @else
            ...
            @endif – Reviews, Hours, and Photos - Travell (2025)
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            #review-not-foundimg img {
                ...
                max-width: 90%;
                /* Limit image width for mobile devices */
            }
  ...
  "@graph": [
    {
      ...
      "address": {
        ...
        "addressLocality": "{{ $searchresult[0]->Name ?? ($locationPatent[0]['Name'] ?? '') }}",
      ...
      @endif
 @if($searchresult[0]->Averagerating != "" && $searchresult[0]->Averagerating != 0 && !empty($sightreviews) && count($sightreviews) > 0)
      "aggregateRating": {
                            ...
                            <div class="tr-thumb-images">
                                <ul>
                                    @if (isset($Sight_image[0]->Image) && $Sight_image[0]->Image != '')
                                        <li>
                                            @if (str_contains($Sight_image[0]->Image, 'vid'))
                                                <video class="gallery-video"
                                                    style="width: 608px; height: 445px; object-fit: cover;" controls
                                                    muted autoplay loop playsinline>
                                                    <source
                                                        src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $Sight_image[0]->Image }}"
                                                        type="video/mp4">
                                                    Your browser does not support the video tag.
                                                </video>
                                            @else
                                                <img src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $Sight_image[0]->Image }}"
                                                    alt="{{ $searchresult[0]->Title }}" height="445" width="608">
                                            @endif
                                        </li>
                                    @else
                                            ...
                                            @foreach ($remainingImages as $image)
                                                <li>
                                                    @if (str_contains($image->Image, 'vid'))
                                                        <video class="gallery-video"
                                                            style="width: 110px; height: 115px; object-fit: cover;"
                                                            controls muted autoplay loop playsinline>
                                                            <source
                                                                src="https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $image->Image }}"
                                                                type="video/mp4">
                                                            Your browser does not support the video tag.
                                                        </video>
                                                    @else
                                                        <img src="@if (isset($image->Image) && $image->Image != '') https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $image->Image }} @endif"
                                                            alt="{{ $searchresult[0]->Title }}" height="115"
                                                            width="110">
                                                    @endif
                                                </li>
                                            @endforeach
                                ...
                                @if (!$Sight_image->isEmpty())
                                    ...
                                    <a href="javascript:void(0);" class="tr-show-all-photos"
                                        @if ($tsightimg == 0) style="height: 41px;
    width: 48px;" @endif>
                                        @if ($tsightimg == 0)
                                            Gallery View
                                        @else
                            ...
                            <div id="demo" class="carousel slide" data-bs-ride="carousel" data-interval="false">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="@if (isset($Sight_image[0]->Image) && $Sight_image[0]->Image != '') https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $Sight_image[0]->Image }}  @else {{ asset('/frontend/hotel-detail/images/no-data-place-image.png') }} @endif "
                                            alt="Tower Bridge" class="d-block w-100" height="452" width="432">
                                    </div>
                                        ...
                                        @if (!$remainingImages->isEmpty())
                                            @foreach ($remainingImages as $image)
                                                <div class="carousel-item">
                                                    <img src="@if (isset($image->Image) && $image->Image != '') https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $image->Image }} @endif"
                                                        alt="" class="d-block w-100" height="452"
                                                        width="432">
                                                </div>
                                            @endforeach
                                        @endif
                                ...
                                @if (!$Sight_image->isEmpty() && $Sight_image->count() > 1)
                                    <div class="carousel-thumbs">
                                        ...
                                        <div class="tr-thumbs-count tr-show-all-photos">Show all {{ $tsightimg }}+
                                        </div>
                        ...
                        <div class="tr-hotel-info">
                            ...
                            <div class="tr-raiting">
                                <div class="tr-review-with-perc">
                                    ...
                                    @if ($searchresult[0]->Averagerating != '' && $searchresult[0]->Averagerating != 0)
                                        <div class="tr-review-name tr-excellent" style="color:{{ $color }}">
                                            {{ $ratingtext }}</div>
                                    @endif
                                </div>
                    ...
                    @if ($searchresult[0]->Award == 1)
                        <div class="tr-hotel-certificated">
                            <div class="tr-families-favourite">
                                ...
                                @if ($searchresult[0]->Award_description != '')
                                    <p>{{ $searchresult[0]->Award_description }}</p>
                                @endif
                            </div>
                        </div>
                    @endif
                  ...
                  <div>
                    ...
                    <div class="tr-about-section">
                                            ...
                                            <li>
                                                <div class="tr-rating">
                                                    ...
                                                    @if ($todayStartTime && $todayEndTime)
                                                        <div>{{ date('h:i A', $todayStartTime) }} -
                                                            {{ date('h:i A', $todayEndTime) }}</div>
                                                    @else
                                                        <div class="tr-timing tr-closed">Closed</div>
                                                    @endif
                                                    <div class="tr-show-other-days">
                                                        <button type="button"
                                                            class="tr-anchor-btn tr-show-other-days-btn"
                                                            data-bs-toggle="modal" data-bs-target="#timingModal">Show
                                                            other days</button>
                                                    </div>
                                                </div>
                                                ...
                                                {{-- Open/Closed Status --}}
                                                @if ($isOpenNow)
                                                    <div class="tr-review"><span class="tr-open-circle"></span>OPEN
                                                        NOW</div>
                                                @else
                                                    <div class="tr-review tr-closed"><span
                                                            class="tr-closed-circle"></span>CLOSED NOW</div>
                                                @endif

                                                <button type="button" class="tr-anchor-btn tr-timing-edit-btn"
                                                    data-bs-toggle="modal" data-bs-target="#timingChangeModal">
                                                    <svg width="16" height="16" viewBox="0 0 16 16"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M8 13.3333H14" stroke="#222222" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M11 2.3334C11.2652 2.06819 11.6249 1.91919 12 1.91919C12.1857 1.91919C12.3696 1.95577 12.5412 2.02684C12.7128 2.09791 12.8687 2.20208 13 2.3334C13.1313 2.46472 13.2355 2.62063 13.3066 2.79221C13.3776 2.96379 13.4142 3.14769 13.4142 3.3334C13.4142 3.51912 13.3776 3.70302 13.3066 3.8746C13.2355 4.04618 13.1313 4.20208 13 4.3334L4.66667 12.6667L2 13.3334L2.66667 10.6667L11 2.3334Z"
                        ...
                        <div class="tr-improve-lisitng">
                            <button type="button" class="tr-anchor-btn" data-bs-toggle="modal"
                                data-bs-target="#improveListingModal">Improve this listing</button>
                        </div>
                        ...
                        @else
                            ...
                            <div class="mt-41">
                                <img src="{{ asset('/frontend/hotel-detail/images/no-data-about.png') }}"
                                    alt="">
                                <div class="tr-improve-lisitng mt-41">
                                    <button type="button" class="tr-anchor-btn" data-bs-toggle="modal"
                                        data-bs-target="#improveListingModal">Write something about the place</button>
                                </div>
                            </div>
...
@endforeach
            ...
            <div class="row">
                <div class="col-sm-12">
                            ...
                            @if (!$get_experience->isEmpty())
                                ...
                                @foreach ($get_experience as $get_experiences)
                                    <div class="tr-top-ways-list">
                                        <div class="tr-img">
                                            <a
                                                href="@if ($get_experiences->viator_url != '') {{ $get_experiences->viator_url }} @endif">
                                                <img loading="lazy"
                                                    src="@if ($get_experiences->Img1 != '') {{ $get_experiences->Img1 }}@else{{ asset('/images/Hotel lobby-image.png') }} @endif"
                                                    alt="top-places" height="117" width="100"
                                                    style="width: 100px; height: 117px !important;">
                                            </a>
                                        </div>
                                        <div class="tr-details">
                                            ...
                                            <div class="tr-place-name">
                                                <a
                                                    href="{{ route('experince', [$get_experiences->slugid . '-' . $get_experiences->ExperienceId . '-' . $get_experiences->Slug]) }}">
                                            ...
                                            <div class="tr-like-review">
                                                ...
                                                <span class="tr-review">({{ $get_experiences->review_count }}
                                                    reviews)</span>
                                            </div>
                                ...
                                @for ($i = 0; $i < $requiredPlaceholders; $i++)
                                    <div class="tr-top-ways-list">
                                        <div class="tr-img">
                                            <img loading="lazy"
                                                src="{{ asset('/frontend/hotel-detail/images/top-way-no-data.png') }}"
                                                alt="top-places">
                                        </div>
                                        <div class="tr-details">
                                            <div class="tr-no-data-text w-100 mb-12"></div>
                    ...
                    <div class="tr-Location-section tr-tab-section">
                        ...
                        <div class="tr-Location-details">
                            <ul>
                                <li class="tr-location-address">
                                    @if ($searchresult[0]->Address != '')
                                        {{ $searchresult[0]->Address }}
                                    @else
                                ...
                                <li class="tr-website-link"><a
                                        href='@if ($searchresult[0]->Website != '') {{ $searchresult[0]->Website }} @endif'
                        ...
                        <div class="tr-location-map">
                            ...
                            @else
                                <div>
                                    <img src="{{ asset('/frontend/hotel-detail/images/no-data-no-map.png') }}"
                                        alt="">
                                    <div class="tr-improve-lisitng mt-24">
                                        <button type="button" class="tr-anchor-btn" data-bs-toggle="modal"
                                            data-bs-target="#improveListingModal">Add location</button>
                                    </div>
                                </div>
                            @endif
                        </div>
                                    ...
                                    @if (!$nearbyatt->isEmpty())
                                            ...
                                            <div class="tr-tourist-place">
                                                <div class="tr-img">
                                                    <a href="javascript:void(0);">
                                                        <img loading="lazy"
                                                            src="{{ asset('/frontend/hotel-detail/images/tourist-places-1.png') }}"
                                                            alt="tourist-places">
                                                    </a>
                                                </div>
                                                <div class="tr-details">
                                                    <div class="tr-place-name">
                                                        <a
                                                            href="{{ route('sight.details', [$nearbyatt->LocationId . '-' . $nearbyatt->SightId . '-' . $nearbyatt->Slug]) }}">
                                                            {{ $nearbyatt->Title }}
                                                        </a>
                                                    </div>
                                        ...
                                        @for ($i = 0; $i < $requiredPlaceholders; $i++)
                                            <div class="tr-tourist-place">
                                                <div class="tr-img">
                                                    <img loading="lazy"
                                                        src="{{ asset('/frontend/hotel-detail/images/no-data-explore.png') }}"
                                                        alt="tourist-places">
                                                </div>
                                                <div class="tr-details">
                                                    <div class="tr-no-data-text w-100 mb-12"></div>
                                    ...
                                    <div class="tr-tourist-place-lists">
                                        ...
                                        @foreach ($get_nearby_rest as $val)
                                            <div class="tr-tourist-place">
                                                <div class="tr-img">
                                                    <a
                                                        href="{{ asset('rd-' . $val->slugid . '-' . $val->RestaurantId . '-' . strtolower($val->Slug)) }}">
                                                        <img loading="lazy"
                                                            src="{{ asset('/images/Hotel lobby-image.png') }}"
                                                            alt="tourist-places">
                                                    </a>
                                                </div>
                                                <div class="tr-details">
                                                    ...
                                                    <div class="tr-like-review">
                                                        @if ($val->TATrendingScore != '' && $val->TATrendingScore != 0)
                                                            ...
                                                            <span class="tr-likes">{{ $result }}%</span>
                                                        @endif
                                                        <span class="tr-review"> .{{ $val->review_count }}
                                                            reviews</span>
                                                    </div>
                                                    <div class="tr-distance">{{ number_format($val->distance, 2) }} km
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                @foreach ($nearby_hotel as $nearby_hotels)
                                    <div class="tr-nearby-hotel-list">
                                        <div class="tr-hotel-img">
                                            <a href="javascript:void(0);">
                                                <img loading="lazy"
                                                    src="https://photo.hotellook.com/image_v2/limit/h{{ $nearby_hotels->hotel_id }}_1/290/291.jpg"
                                        ...
                                        <div class="tr-hotel-deatils">
                                            <div class="tr-hotel-name">
                                                <a
                                                    href="{{ route('hotel.detail', [$nearby_hotels->location_id . '-' . $nearby_hotels->hotelid . '-' . $nearby_hotels->slug]) }}">
                                                    {{ $nearby_hotels->name }}
                                                </a>
                                            </div>
                                            ...
                                            <div class="tr-like-review">
                                                ...
                                                @if ($nearby_hotels->stars != '' && $nearby_hotels->stars != 0)
                                                    ...
                                                    <span class="tr-vgood"
                                                        style="color:{{ $color }}">{{ $ratingtext }}</span>
                                                @endif
                                            </div>
                                ...
                                @if ($nearby_hotel->count() < 4)
                                    @for ($i = 0; $i < 4 - $nearby_hotel->count(); $i++)
                                        <div class="tr-nearby-hotel-list">
                                            <div class="tr-hotel-img">
                                                <img loading="lazy"
                                                    src="{{ asset('/frontend/hotel-detail/images/no-data-nearby-hotel.png') }}"
                                                    alt="NearBy Hotel">
                                            </div>
                                            <div class="tr-hotel-deatils">
                                                <div class="tr-no-data-text w-100 mb-12"></div>
                                ...
                                <div class="tr-review-content">
                                    @if ($searchresult[0]->ReviewSummaryLabel != '')
                                        <div class="tr-power-by">
                                            ...
                                            <ul>
                                                <li><img loading="lazy"
                                                        src="{{ asset('/frontend/hotel-detail/images/ellipse-1.png') }}"
                                                        alt="ellipse"></li>
                                                <li><img loading="lazy"
                                                        src="{{ asset('/frontend/hotel-detail/images/ellipse-2.png') }}"
                                                        alt="ellipse"></li>
                                                <li><img loading="lazy"
                                                        src="{{ asset('/frontend/hotel-detail/images/ellipse-3.png') }}"
                                                        alt="ellipse"></li>
                                                <li>
                                                    <img loading="lazy"
                                                        src="{{ asset('/frontend/hotel-detail/images/ellipse-4.png') }}"
                                                        alt="ellipse">
                                    ...
                                    @endif
                                    @if ($searchresult[0]->ReviewSummary != '')
                                        <p>{{ $searchresult[0]->ReviewSummary }}</p>
                                    @endif

                                    @if (!$sightreviews->isEmpty())
                                        <a href="javascript:void(0);" class="tr-jump-to-all-review">Jump to all
                                            reviews</a>
                                ...
                                @if (!$sightreviews->isEmpty())
                                    ...
                                    <div class="tr-reviews-graph">
                                        <div class="tr-reviews-graph-details">
                                            ...
                                            <div class="tr-likes-count review-rating-count">
                                                {{ floor($averageRatingPercentage) }}%</div>
                                        ...
                                        <div class="tr-rating-types">
                                            ...
                                            <div class="tr-rating-type">
                                                ...
                                                <div class="tr-reviews-nums notrcmd-count">{{ $notRecommendedCount }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tr-reviews-mentioned">
                                        ...
                                        <ul>
                                            <li><a href="javascript:void(0);" class="filter-option"
                                                    data-filter="recommended">Recommended</a></li>
                                            <li><a href="javascript:void(0);" class="filter-option"
                                                    data-filter="not_recommended">Not Recommended</a></li>
                                        </ul>
                                        <div class="tr-shotby">
                                                    ...
                                                    <div class="tr-customer-review">
                                                        <div class="tr-customer-details">
                                                            <div class="tr-customer-detail">
                                                                <img loading="lazy"
                                                                    src="{{ asset('/frontend/hotel-detail/images/usericon-review.png') }}"
                                                                    alt="customer">
                                ...
                                @else
                                    <div class="col-lg-7" id="review-not-foundimg">
                                        <img src="{{ asset('/frontend/hotel-detail/images/no-review-found.png') }}"
                                            alt="No Reviews Found" style="height: 350px;">
                ...
                <div class="tr-faqs-section mb-5">
                    <h3 class="d-none d-md-block mb-4">FAQ's about the {{ $searchresult[0]->Title }}</h3>
                    <h3 class="d-block d-sm-block d-md-none mb-3">FAQ's</h3>
                    <span id="detailfaqdata">
                        <!-- Timing Information Section -->
                        @if (!empty($timings))
                            <div class="tr-qa-item mb-4 p-1">
                                <div class="tr-question fw-bold mb-2" id="timing-question">When is {{ $searchresult[0]->Title }} open</div>
                                <div class="tr-answer">
                                    <div class="timing-details">
                                        <div class="table-responsive">
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    @if(count($timings) > 0)
                                                        @foreach ($timings as $day => $hours)
                                                            <tr>
                                                                <td class="fw-bold py-1">{{ ucfirst($day) }}</td>
                                                                <td class=" {{ $day == strtolower(now()->format('l'))  }} py-1 pe-3">
                        ...
                        @if (isset($faq) && !empty((array) $faq))
                            <div class="tr-faqs-ques-ans">
                                @foreach ($faq as $faqItem)
                                    <div class="tr-qa-item mb-4 p-1">
                                        <div class="tr-question fw-bold mb-2">{{ $faqItem->Faquestion }}</div>
                                        <div class="tr-answer">{!! $faqItem->Answer !!}</div>
                                    </div>
                                @endforeach
                            </div>
                        @else
                        ...
                        <ul class="tr-breadcrumb">
                            ...
                            @if (!empty($breadcumb))
                                @if ($breadcumb[0]->ccName != '')
                                    <li>
                                        <a href="{{ route('explore_continent_list', [$breadcumb[0]->contid, $breadcumb[0]->ccName]) }}"
                                            target="_blank">
                                            {{ $breadcumb[0]->ccName }}
                                        </a>
                                    </li>
                            ...
                            @if (!empty($locationPatent))
                                ...
                                @foreach ($locationPatent as $location)
                                    <li>
                                        <a href="{{ route('search.results', [$location['LocationId'] . '-' . strtolower($location['slug'])]) }}"
                                            target="_blank">
                                            {{ $location['Name'] }}
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a href="{{ route('search.results', [$searchresult[0]->slugid . '-' . strtolower($searchresult[0]->Lslug)]) }}"
                                    target="_blank">
                            ...
                            <div class="tr-day-time">
                                ...
                                @if ($currentTimestamp >= $startTimestamp && $currentTimestamp < $endTimestamp)
                                    <div class="tr-timing">
                                        ...
                                        {{ date('h:i A', $startTimestamp) }} - {{ date('h:i A', $endTimestamp) }}
                                        (OPEN NOW)
                                    </div>
                                @else
                                    <div class="tr-timing">
            ...
            <div class="tr-write-review-content">
                <div class="tr-hotel-reviews-details">
                    <div class="tr-main-image">
                        <img src="@if (isset($Sight_image[0]->Image) && $Sight_image[0]->Image != '') https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $Sight_image[0]->Image }}  @else {{ asset('/frontend/hotel-detail/images/no-data-place-image.png') }} @endif "
                            alt="Tower Bridge" class="d-block w-100" height="200" width="482">
                    </div>
                    <div class="tr-hotel-info">
                        ...
                        @if (!$Sight_image->isEmpty())
                            @foreach ($Sight_image as $image)
                                <li data-bs-toggle="modal" data-bs-target="#gallerySliderModal">
                                    <img loading="lazy"
                                        src="@if (isset($image->Image) && $image->Image != '') https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/{{ $image->Image }} @endif"
                                        alt="Outdoor Pictures 1" height="300" height="270">
                                </li>
                            @endforeach
                        @endif
                    </ul>
                ...
                <form id="s-review" class="add_review">
                    <div class="tr-overall-rating">
                        <div class="tr-rating">
                            ...
                            <div class="tr-recommended-actions">
                                <label>
                                    <input type="radio" class="write-review recommend selected" name="rating"
                                        value="1">
                                    <span style="">Yes</span>
                                </label>
                                <label>
                                    <input type="radio" class="write-review recommend" name="rating"
                                        value="0">
                                    <span>No</span>
                                </label>
                            </div>
                    ...
                    <div class="tr-review-image">
                        ...
                        <div class="tr-file-upload">
                            ...
                            <div class="tr-image-upload-wrap">
                                <input class="tr-file-upload-input" type='file' id="files" name="files[]"
                    ...
                    @if (!$gettiming->isEmpty())
                        ...
                        @if (isset($timings[$currentDay]))
                            ...
                            <div class="tr-day-time">
                                ...
                                @elseif(
                                    ($todayStartTime == '00:00' && $todayEndTime == '00:00') ||
                                        ($todayStartTime == 'closed' && $todayEndTime == 'closed'))
                                ...
                                @elseif($todayStartTime != 'closed' && $todayEndTime != 'closed')
                                    @if ($currentTime >= $todayStartTime && $currentTime <= $todayEndTime)
                                        <div class="tr-timing"><span
                                                class="tr-open-circle"></span>{{ date('h:i A', strtotime($todayStartTime)) }}
                                            - {{ date('h:i A', strtotime($todayEndTime)) }} (OPEN NOW)</div>
                                    @else
                                        <div class="tr-timing">{{ date('h:i A', strtotime($todayStartTime)) }} -
                                            {{ date('h:i A', strtotime($todayEndTime)) }} (CLOSED NOW)</div>
                                    @endif
                                @else
                                    <div class="tr-timing tr-closed">Closed Today</div>
                                @endif
                            ...
                            <div class="tr-day-time">
                                ...
                                @if (isset($timings[$day]))
                                    ...
                                    @elseif($startTime != 'closed' && $endTime != 'closed')
                                        <div class="tr-timing">{{ date('h:i A', strtotime($startTime)) }} -
                                            {{ date('h:i A', strtotime($endTime)) }}</div>
                                    @else
                                        <div class="tr-timing tr-closed">Closed</div>
                                    @endif
                ...
                <div class="tr-days-time-section">
                    <div class="tr-day-time">
                        ...
                        <div class="tr-timing tr-closed">
                            09:00 AM - 01:30 PM
                            <button type="button" class="tr-anchor-btn" data-bs-toggle="modal"
                                data-bs-target="#timingEditModal">
    ...
    <div class="modal" id="timingEditModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>Select Time</h5>
                    <button type="button" class="tr-back-btn" data-bs-toggle="modal"
                        data-bs-target="#timingChangeModal">Back Button</button>
                </div>
                <div class="tr-days-time-section">
                ...
                <div class="tr-timing-field">
                    ...
                    <div class="tr-remove-day">
                        <button type="button" class="tr-anchor-btn" title="Remove"><svg width="20"
                                height="23" viewBox="0 0 31 33" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="tr-place-details">
                    <div class="tr-image">
                        <img loading="lazy"
                            src="@if (isset($Sight_image[0]->Image) && $Sight_image[0]->Image != '') {{ asset('https://s3-us-west-2.amazonaws.com/s3-travell/Sight-images/' . $Sight_image[0]->Image) }} @else {{ asset('/images/Hotel lobby.svg') }} @endif "
                            alt="{{ $searchresult[0]->Title }}">
                    </div>
                    <div class="tr-details">
                        ...
                        <div class="tr-like-review">
                            ...
                            @if ($searchresult[0]->Averagerating != '' && $searchresult[0]->Averagerating != 0)
                                ...
                                <div class="tr-ranting-percent">{{ $result }}%
                                @else
                                    --
                            @endif
                        </div>
            ...
            <div class="tr-field-row">
                <div class="tr-field">
                    ...
                    <input type="text" class="form-control" placeholder="2-3" id="suggestHours"
                        name="" value="">
                </div>
            </div>
            <div class="tr-field-row">
                <div class="tr-field">
                    ...
                    <input type="text" class="form-control tr-timing-field" placeholder="Add open hours"
                        id="timing" name="" value="" data-bs-toggle="modal"
                        data-bs-target="#timingChangeModal">
                </div>
            </div>
            <div class="tr-field-row">
                <div class="tr-field">
            ...
            <div class="tr-review-image">
                ...
                <div class="tr-file-upload">
                    <div class="tr-image-upload-wrap">
                        <input class="tr-file-upload-input" type='file' id="mediaInput" name="media[]"
                            onchange="handleFileSelect(this)" accept="image/*,video/*" multiple />
                        <div class="tr-drag-image">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_441_7517)">
...
<script>
    $(document).ready(function() {
        ...
        $('#saveTiming').click(function(e) {
            ...
            const selectedDays = [];
            const dayIds = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday',
                'saturday'];
            ...
            if (!isTwentyFourHours && !isClosed) {
                $('.tr-weekday input[type="checkbox"]:checked').each(function() {
                    ...
                    $('.tr-timing-field').each(function() {
                        const openTime = $(this).find('input[placeholder="10:00 AM"]')
                            .val();
                        const closeTime = $(this).find('input[placeholder="--:-- --"]')
                            .val();
            ...
            $('#mediaUpload').change(function(e) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    if (isImage) {
                        ...
                        previewDiv.html('<video controls src="' + URL.createObjectURL(file) +
                            '"></video>');
                    }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Remove duplicate timing questions
        const timingQuestions = document.querySelectorAll('.tr-question:not(#timing-question)');
        timingQuestions.forEach(function(element) {
            if (element.textContent.includes('When is') && element.textContent.includes('open')) {
                element.remove();
            }
        });
    });
