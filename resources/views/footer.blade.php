        ...
        <div class="col-sm-12">
          <div class="tr-footer-top">
            <div class="tr-footer-logo">
              <a href="https://www.travell.co.in/"><img 
                  src="{{asset('/frontend/hotel-detail/images/travell-white-logo.png')}}"
                  alt="travell-white-logo"></a>
              <div class="tr-copy-right tr-mobile">&copy; 2025 Travell.co.in, Inc.</div>
            </div>
            <div class="tr-footer-links-section">
              <div class="tr-footer-links-left-col">
                <div class="tr-footer-links">
                  <h5>About</h5>
                  <ul>
                    <li><a href="https://www.travell.co.in/about-us">About Us</a></li>
                    <li><a href="https://www.travell.co.in/career">Careers</a></li>
              ...
              <div class="tr-footer-links-right-col">
                <div class="tr-footer-links">
                  <h5>Rooms</h5>
                  <ul>
                    <li><a href="https://www.travell.co.in/stays">Hotels</a></li>
                    <li><a href="https://www.travell.co.in/stays">Motels</a></li>
                    <li><a href="https://www.travell.co.in/stays">Apartments</a></li>
                  </ul>
                </div>
                <div class="tr-footer-links">
                  <h5>Explore</h5>
                  <ul>
                    <li><a href="https://www.travell.co.in/lo-129700020031-london-england">London</a></li>
                    <li><a href="https://www.travell.co.in/lo-113600100005-paris-ile-de-france">Paris</a></li>
                    <li><a href="https://www.travell.co.in/lo-131300370558-new-york-city-new-york-ny">New York</a></li>
                  </ul>
                </div>
              </div>
            </div>
